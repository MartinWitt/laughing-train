...
/**
 *  Interface for cleaning a change. This is used to remove unnecessary changes from the diff. For example if a change is only a whitespace change, it can be removed.
 */
