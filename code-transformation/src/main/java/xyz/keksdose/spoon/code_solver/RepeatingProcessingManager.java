...
/**
 * This class is responsible for applying the transformations to the given elements, till no more
 * changes are detected. The transformations are applied in the order they are added to the
 * TransformationEngine. Use {@link #process(Collection)} to apply the transformations to the given
 * elements.
 */
