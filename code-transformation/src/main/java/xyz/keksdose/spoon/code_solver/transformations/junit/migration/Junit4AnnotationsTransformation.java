...
public class Junit4AnnotationsTransformation extends TransformationProcessor<CtMethod<?>> {
  ...
  private void refactorBeforeClass(CtMethod<?> method) {
    Optional<CtAnnotation<?>> beforeClassAnnotation =
        JunitHelper.getJunit4BeforeClassAnnotation(method);
    if (beforeClassAnnotation.isPresent()) {
      adjustImportsBeforeClass(method);
      replaceAnnotation(
          method, beforeClassAnnotation.get(), createBeforeAllAnnotation(getFactory()));
      String changeText =
          String.format(
              "Replaced @BeforeClass annotation with @BeforeAll at method %s",
  ...
  private void replaceAnnotation(
      CtMethod<?> method, CtAnnotation<?> oldAnnotation, CtAnnotation<?> newAnnotation) {
  ...
  private void refactorBefore(CtMethod<?> method) {
    ...
    if (beforeAnnotation.isPresent()) {
      ...
      String changeText =
          String.format(
              "Replaced @Before annotation with @BeforeEach at method %s", method.getSimpleName());
      String markdownText =
          String.format(
  ...
  private void refactorAfter(CtMethod<?> method) {
    ...
    if (afterAnnotation.isPresent()) {
      ...
      replaceAnnotation(
          method, afterAnnotation.get(), JunitHelper.createAfterEachAnnotation(getFactory()));
      String changeText =
          String.format(
              "Replaced @After annotation with @AfterEach at method %s", method.getSimpleName());
      String markdownText =
          String.format(
  ...
  private void adjustImportsAfter(CtMethod<?> method) {
    ...
    ImportHelper.addImport(
        "org.junit.jupiter.api.AfterEach", false, method.getPosition().getCompilationUnit());
  }
  ...
  private void adjustImportsAfterClass(CtMethod<?> method) {
    ...
    ImportHelper.addImport(
        "org.junit.jupiter.api.AfterAll", false, method.getPosition().getCompilationUnit());
  }
  ...
  private void refactorIgnore(CtMethod<?> method) {
    ...
    if (ignoreAnnotation.isPresent()) {
      ...
      String changeText =
          String.format(
              "Replaced @Ignore annotation with @Disabled at method %s", method.getSimpleName());
      String markdownText =
          String.format(
  ...
  private static final class BeforeClassBadSmell extends BadSmell {
    ...
    public MarkdownString getDescription() {
      String rawText =
          "The JUnit 4 @BeforeClass annotation should be replaced JUnit junit 5 BeforeAll annotation.";
      String markdownText =
  ...
  private static final class BeforeBadSmell extends BadSmell {
    ...
    public MarkdownString getDescription() {
      String rawText =
          "The JUnit 4 @Before annotation should be replaced JUnit junit 5 BeforeEach annotation.";
      String markdownText =
  ...
  private static final class AfterBadSmell extends BadSmell {
    ...
    public MarkdownString getDescription() {
      String rawText =
          "The JUnit 4 @After annotation should be replaced JUnit 5 @AfterEach annotation.";
      String markdownText =
  ...
  private static final class AfterClassBadSmell extends BadSmell {
    ...
    public MarkdownString getDescription() {
      String rawText =
          "The JUnit 4 @AfterClass annotation should be replaced JUnit 5 @AfterAll annotation.";
      String markdownText =
