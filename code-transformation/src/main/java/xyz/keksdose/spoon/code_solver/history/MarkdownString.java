...
/**
 * This class wrappes a string with it's markdown formatted value. Use this class to create markdown
 * formatted strings. {@link asString()} returns the raw string. {@link asMarkdown()} returns the
...
public class MarkdownString {
  ...
  /**
   * Creates a markdown string from the given markdown text. The text is the same as the markdown
   * text. All {@code `} are removed in the raw text.
   *
