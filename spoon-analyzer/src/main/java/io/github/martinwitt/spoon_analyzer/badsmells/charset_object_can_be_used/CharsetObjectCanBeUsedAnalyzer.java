...
public class CharsetObjectCanBeUsedAnalyzer implements LocalAnalyzer, LocalRefactor<CharsetObjectCanBeUsed> {
    ...
    private static final List<InvocationMatcher> matcher = List.of(
            ...
            new InvocationMatcher("java.net.URLDecoder", "decode", "java.lang.String", "java.lang.String"),
            new InvocationMatcher("java.net.URLEncoder", "encode", "java.lang.String", "java.lang.String"),
            ...
            new InvocationMatcher(
                    ...
                    "java.lang.String",
                    "java.lang.String"));
    private static final List<ConstructorMatcher> ctorMatcher = List.of(
            new ConstructorMatcher("java.lang.InputStreamerReader", "java.io.InputStream", "java.lang.String"),
            new ConstructorMatcher("java.lang.OutputStreamWriter", "java.io.OutputStream", "java.lang.String"),
            ...
            new ConstructorMatcher("java.util.Scanner", "java.nio.channels.ReadableByteChannel", "java.lang.String"),
            new ConstructorMatcher("java.io.PrintStream", "java.io.OutputStream", "boolean", "java.lang.String"),
            ...
            new ConstructorMatcher("java.io.PrintWriter", "java.io.OutputStream", "boolean", "java.lang.String"),
    ...
    public void refactor(CharsetObjectCanBeUsed badSmell) {
        List<CtExpression<?>> arguments = Optional.ofNullable(badSmell.getInvocation())
        ...
        if (ctExpression instanceof CtLiteral) {
            ...
            if (string != null) {
                ctExpression.replace(ctExpression
                        .getFactory()
