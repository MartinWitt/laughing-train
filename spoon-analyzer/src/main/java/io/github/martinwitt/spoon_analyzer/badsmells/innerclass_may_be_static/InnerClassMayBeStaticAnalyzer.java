...
public class InnerClassMayBeStaticAnalyzer implements LocalAnalyzer, LocalRefactor<InnerClassMayBeStatic> {
    ...
    private boolean referencesParentWithField(CtType<?> innerClazz) {
        for (CtFieldReference<?> fieldReference : innerClazz.getElements(new TypeFilter<>(CtFieldReference.class))) {
