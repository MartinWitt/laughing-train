...
/**
 * This class represents a position in a text. It is used to identify the position of an element in
 * a source file.
 *
...
public record Position(
    int startLine, int endLine, int startColumn, int endColumn, int charOffset, int charLength)
