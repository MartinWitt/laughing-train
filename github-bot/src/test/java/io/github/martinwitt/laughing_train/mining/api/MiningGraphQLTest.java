...
class MiningGraphQLTest {
    ...
    public  void testRecentRuns() {
        ...
        AnalyzerStatus analyzerStatus = Instancio.create(AnalyzerStatus.class);
        analyzerStatus.setLocalDateTime(LocalDateTime.now());
        commit.addAnalyzerStatus(analyzerStatus);
