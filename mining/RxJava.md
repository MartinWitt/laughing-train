# ReactiveX/RxJava# Bad smells
I found 1393 bad smells with 61 repairable:
...
## MethodMayBeStatic
### MethodMayBeStatic
Method `lvNextBufferAndUnlink()` may be 'static'
in `src/main/java/io/reactivex/rxjava3/operators/SpscLinkedArrayQueue.java`
#### Snippet
```java
...
a1693ec David Karnok
### MethodMayBeStatic
Method `appendStackTrace()` may be 'static'
in `src/main/java/io/reactivex/rxjava3/exceptions/CompositeException.java`
#### Snippet
```java
    }
