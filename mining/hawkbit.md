...
# Bad smells
I found 849 bad smells with 51 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 311 | false |
| ReturnNull | 131 | false |
| DefaultAnnotationParam | 44 | false |
...
### UNUSED_IMPORT
Unused import `import org.eclipse.hawkbit.repository.model.Rollout;`
in `hawkbit-repository/hawkbit-repository-jpa/src/main/java/org/eclipse/hawkbit/repository/jpa/JpaDeploymentManagement.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.eclipse.hawkbit.repository.model.RolloutGroup;`
in `hawkbit-repository/hawkbit-repository-jpa/src/main/java/org/eclipse/hawkbit/repository/jpa/JpaDeploymentManagement.java`
#### Snippet
```java
import org.eclipse.hawkbit.repository.model.DistributionSetType;
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-04-15-17-02.303.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
