...
in `service/device/registry/test-steps/src/main/java/org/eclipse/kapua/artemis/ArtemisEmbeddedTest.java`
#### Snippet
```java
...
### CommentedOutCode
Commented out code (6 lines)
in `service/device/registry/test-steps/src/main/java/org/eclipse/kapua/artemis/ArtemisTest.java`
#### Snippet
```java
    }
...
### CommentedOutCode
Commented out code (3 lines)
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/authentication/AuthenticationLogic.java`
#### Snippet
```java
...
in `service/camel/src/main/java/org/eclipse/kapua/service/camel/application/KapuaApplication.java`
#### Snippet
```java
...
### AssignmentToStaticFieldFromInstanceMethod
Assignment to static field `server` from instance context
in `service/device/registry/test-steps/src/main/java/org/eclipse/kapua/artemis/ArtemisEmbeddedTest.java`
#### Snippet
```java
            if (server != null) {
...
### ObjectNotify
`notify` should probably be replaced with 'notifyAll()'
in `client/security/src/main/java/org/eclipse/kapua/client/security/MessageListener.java`
#### Snippet
```java
...
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/context/SecurityContext.java`
#### Snippet
```java
            }
            else {
...
### ClassNameSameAsAncestorName
Class name `MqttCallback` is the same as one of its superclass' names
in `service/device/registry/test-steps/src/main/java/org/eclipse/kapua/artemis/MqttCallback.java`
#### Snippet
```java
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `brokerHost` is accessed in both synchronized and unsynchronized contexts
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/utils/BrokerIdentity.java`
#### Snippet
```java
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `brokerId` is accessed in both synchronized and unsynchronized contexts
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/utils/BrokerIdentity.java`
#### Snippet
```java
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `waitBeforeDisconnect` is accessed in both synchronized and unsynchronized contexts
in `qa/integration-steps/src/main/java/org/eclipse/kapua/qa/integration/steps/MqttClientPoolSteps.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-22-01-57-35.718.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### SynchronizeOnThis
Lock operations on a class may have unforeseen side-effects
in `service/camel/src/main/java/org/eclipse/kapua/service/camel/setting/ServiceSetting.java`
#### Snippet
```java
     */
    public static ServiceSetting getInstance() {
        synchronized (ServiceSetting.class) {
            if (instance == null) {
...
### SynchronizeOnThis
Lock operations on a class may have unforeseen side-effects
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/setting/BrokerSetting.java`
#### Snippet
```java
     */
...
### SynchronizeOnThis
Lock operations on a class may have unforeseen side-effects
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/setting/ServiceAuthenticationSetting.java`
#### Snippet
```java
     */
...
### SynchronizeOnThis
Lock operations on a class may have unforeseen side-effects
in `service/client/src/main/java/org/eclipse/kapua/service/client/setting/ServiceClientSetting.java`
#### Snippet
```java
     */
...
### SynchronizeOnThis
Lock operations on a class may have unforeseen side-effects
in `service/client/src/main/java/org/eclipse/kapua/service/client/protocol/ProtocolDescriptorProviders.java`
#### Snippet
```java
     */
...
### UnusedAssignment
Variable `textPayload` initializer `null` is redundant
in `client/security/src/main/java/org/eclipse/kapua/client/security/MessageHelper.java`
#### Snippet
```java
...
### UnusedAssignment
Variable `textPayload` initializer `null` is redundant
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/AuthenticationServiceListener.java`
#### Snippet
```java
...
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/authentication/DefaultAuthenticator.java`
#### Snippet
```java
    @Override
...
### UnnecessarySemicolon
Unnecessary semicolon `;`
in `service/authentication-app/src/main/java/org/eclipse/kapua/service/authentication/AuthenticationRouteHealthIndicator.java`
#### Snippet
```java
                running++;
            }
...
### NonStrictComparisonCanBeEquality
Can be replaced with equality
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/context/Acl.java`
#### Snippet
```java
...
### DynamicRegexReplaceableByCompiledPattern
`split()` could be replaced with compiled 'java.util.regex.Pattern' construct
in `service/client/src/main/java/org/eclipse/kapua/service/client/protocol/DefaultProtocolDescriptionProvider.java`
#### Snippet
```java
...
### SynchronizationOnLocalVariableOrMethodParameter
Synchronization on local variable `responseContainer`
in `client/security/src/main/java/org/eclipse/kapua/client/security/ServiceClientMessagingImpl.java`
#### Snippet
```java
...
### ReturnNull
Return of `null`
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/SecurityPlugin.java`
#### Snippet
```java
        }
        catch (Exception e) {
...
Externalizable class `ServiceConnectionFactoryImpl` has no 'public' no-arg constructor
in `service/client/src/main/java/org/eclipse/kapua/service/client/amqp/ServiceConnectionFactoryImpl.java`
#### Snippet
```java
import org.slf4j.LoggerFactory;
...
in `service/client/src/main/java/org/eclipse/kapua/service/client/protocol/CachingProtocolDescriptorProvider.java`
#### Snippet
```java
...
in `commons/src/main/java/org/eclipse/kapua/commons/localevent/EventHandler.java`
#### Snippet
```java
    }
...
### BoundedWildcard
Can generalize to `? extends AuthAcl`
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/context/Acl.java`
#### Snippet
```java
...
### MissortedModifiers
Missorted modifiers `final static`
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/ServerContext.java`
#### Snippet
```java
...
### MissortedModifiers
Missorted modifiers `final static`
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/authentication/AclCreator.java`
#### Snippet
```java
...
### EmptyMethod
The method is empty
in `service/authentication-app/src/main/java/org/eclipse/kapua/service/authentication/AuthenticationApplication.java`
#### Snippet
```java
    }
...
### ConstantValue
Condition `authRequest!=null` is always `true`
in `client/security/src/main/java/org/eclipse/kapua/client/security/MessageHelper.java`
#### Snippet
```java
        buildBaseMessage(message, authRequest);
...
### ConstantValue
Condition `entityRequest!=null` is always `true`
in `client/security/src/main/java/org/eclipse/kapua/client/security/MessageHelper.java`
#### Snippet
```java
        buildBaseMessage(message, entityRequest);
...
### DataFlowIssue
Method invocation `getResultCode` may produce `NullPointerException`
in `service/authentication/src/main/java/org/eclipse/kapua/service/authentication/AuthenticationServiceListener.java`
#### Snippet
```java
...
Deprecated member 'setJobStepProperties' is still used
in `service/job/api/src/main/java/org/eclipse/kapua/service/job/step/JobStepCreator.java`
#### Snippet
```java
     */
    @Deprecated
...
### DeprecatedIsStillUsed
Deprecated member 'CIPHER_KEY' is still used
in `commons/src/main/java/org/eclipse/kapua/commons/crypto/setting/CryptoSettingKeys.java`
#### Snippet
```java
     */
    @Deprecated
...
### Convert2MethodRef
Lambda can be replaced with method reference
in `broker/artemis/plugin/src/main/java/org/eclipse/kapua/broker/artemis/plugin/security/ServerPlugin.java`
#### Snippet
```java
...
```java
    ...
    private static final String DEFAULT_DATA_DIRECTORY_PREFIX = "target/artemis" + UUID.randomUUID().toString();
...
### SynchronizeOnNonFinalField
Synchronization on a non-final field `client`
in `qa/integration-steps/src/main/java/org/eclipse/kapua/qa/integration/steps/MqttClientPoolSteps.java`
#### Snippet
```java
        try {
...
in `service/camel/src/main/java/org/eclipse/kapua/service/camel/listener/error/FailureProcessor.java`
#### Snippet
```java
        }
        else {
...
in `service/camel/src/main/java/org/eclipse/kapua/service/camel/message/JmsUtil.java`
#### Snippet
```java
    }
...
### UnnecessaryFullyQualifiedName
Qualifier `org.apache.camel` is unnecessary and can be removed
in `service/camel/src/main/java/org/eclipse/kapua/service/camel/listener/error/ErrorMessageListener.java`
#### Snippet
```java
