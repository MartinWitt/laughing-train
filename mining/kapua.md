...
# Bad smells
I found 1992 bad smells with 384 repairable:
...
## RuleId[ruleID=SuspiciousDateFormat]
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-24-12-28-12.822.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### DataFlowIssue
Condition `t instanceof DatabaseException` is redundant and can be replaced with a null check
in `commons/src/main/java/org/eclipse/kapua/commons/util/KapuaExceptionUtils.java`
#### Snippet
```java
                t = t.getCause();
            }
