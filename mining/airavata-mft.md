...
Class `SwiftUtil` has only 'static' members, and lacks a 'private' constructor
...
### UNUSED_IMPORT
Unused import `import org.jclouds.ContextBuilder;`
in `transport/swift-transport/src/main/java/org/apache/airavata/mft/transport/swift/SwiftIncomingConnector.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.jclouds.openstack.keystone.auth.config.CredentialTypes;`
in `transport/swift-transport/src/main/java/org/apache/airavata/mft/transport/swift/SwiftIncomingConnector.java`
#### Snippet
```java
import org.jclouds.ContextBuilder;
...
### UNUSED_IMPORT
Unused import `import org.jclouds.openstack.keystone.config.KeystoneProperties;`
in `transport/swift-transport/src/main/java/org/apache/airavata/mft/transport/swift/SwiftIncomingConnector.java`
#### Snippet
```java
import org.jclouds.http.options.GetOptions;
