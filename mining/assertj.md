...
# Bad smells
I found 1666 bad smells with 52 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| UnnecessaryFullyQualifiedName | 769 | false |
| BoundedWildcard | 130 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-12-19-59-28.321.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
