...
# Bad smells
I found 1431 bad smells with 223 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 324 | false |
| BoundedWildcard | 171 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-17-04-44-50.485.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
