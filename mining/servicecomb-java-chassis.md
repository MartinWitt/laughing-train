...
# Bad smells
I found 1448 bad smells with 226 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 327 | false |
| BoundedWildcard | 172 | false |
| UtilityClassWithoutPrivateConstructor | 158 | true |
| AssignmentToMethodParameter | 101 | false |
| RedundantFieldInitialization | 53 | false |
| NonProtectedConstructorInAbstractClass | 41 | true |
| FieldAccessedSynchronizedAndUnsynchronized | 39 | false |
| DataFlowIssue | 36 | false |
| MissingSerialAnnotation | 28 | false |
| ClassCanBeRecord | 28 | false |
...
### BoundedWildcard
Can generalize to `? extends HandlerConfig`
in `core/src/main/java/org/apache/servicecomb/core/handler/config/Config.java`
#### Snippet
```java
...
in `handlers/handler-loadbalance/src/main/java/org/apache/servicecomb/loadbalance/LoadbalanceHandler.java`
#### Snippet
```java
...
Contents of collection `extentionsFactories` are queried, but never updated
in `handlers/handler-loadbalance/src/main/java/org/apache/servicecomb/loadbalance/BeansHolder.java`
#### Snippet
```java
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `requestEx` is accessed in both synchronized and unsynchronized contexts
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `invocation` is accessed in both synchronized and unsynchronized contexts
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
...
### RedundantFieldInitialization
Field initialization to `null` is redundant
in `spring-boot/spring-boot-starters/java-chassis-spring-boot-starter-servlet/src/main/java/org/apache/servicecomb/springboot2/starter/servlet/RestServletInitializer.java`
#### Snippet
```java
...
### RedundantFieldInitialization
Field initialization to `null` is redundant
in `edge/edge-core/src/main/java/org/apache/servicecomb/edge/core/EdgeInvocation.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-25-11-24-04.993.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
in `transports/transport-highway/src/main/java/org/apache/servicecomb/transport/highway/HighwayServerInvoke.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `ExtensionsManager` has only 'static' members, and lacks a 'private' constructor
...
Deprecated member 'getProviderQpsFlowControlHandler' is still used
...
### PublicFieldAccessedInSynchronizedContext
Non-private field `this.requestEx` accessed in synchronized context
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
    try {
...
### PublicFieldAccessedInSynchronizedContext
Non-private field `requestEx` accessed in synchronized context
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
...
Synchronization on a non-final field `this.requestEx`
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
    try {
...
### NonProtectedConstructorInAbstractClass
Constructor `AbstractRestInvocation()` of an abstract class should not be declared 'public'
in `common/common-rest/src/main/java/org/apache/servicecomb/common/rest/AbstractRestInvocation.java`
#### Snippet
```java
...
### AssignmentToMethodParameter
Assignment to method parameter `asyncResp`
in `handlers/handler-loadbalance/src/main/java/org/apache/servicecomb/loadbalance/LoadbalanceHandler.java`
#### Snippet
```java
  public void handle(Invocation invocation, AsyncResponse asyncResp) throws Exception {
...
### AssignmentToMethodParameter
Assignment to method parameter `e`
in `core/src/main/java/org/apache/servicecomb/core/handler/impl/ProducerOperationHandler.java`
#### Snippet
```java
