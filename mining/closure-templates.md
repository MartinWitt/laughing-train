...
| --- | --- | --- |
| BoundedWildcard | 409 | false |
| AssignmentToMethodParameter | 194 | false |
| AbstractClassNeverImplemented | 184 | false |
| DataFlowIssue | 183 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-11-28-01-28-09.702.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
