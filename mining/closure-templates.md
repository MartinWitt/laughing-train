...
# Bad smells
I found 2031 bad smells with 111 repairable:
...
| UnnecessaryStringEscape | 12 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-05-06-13-32.524.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
