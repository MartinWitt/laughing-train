...
# Bad smells
I found 1901 bad smells with 61 repairable:
...
| DynamicRegexReplaceableByCompiledPattern | 46 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-03-15-01-04-06.413.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
