...
# Bad smells
I found 1762 bad smells with 26 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 283 | false |
| DataFlowIssue | 274 | false |
| UnstableApiUsage | 224 | false |
| AbstractClassNeverImplemented | 192 | false |
| UnnecessaryFullyQualifiedName | 166 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-10-17-08-24.982.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
