...
# Bad smells
I found 1756 bad smells with 27 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 282 | false |
| DataFlowIssue | 270 | false |
| UnstableApiUsage | 221 | false |
...
| JavaReflectionMemberAccess | 11 | false |
...
| JavaReflectionInvocation | 4 | false |
...
### NonShortCircuitBoolean
Non-short-circuit boolean expression `allCasesHaveDefiniteControlFlow &= !CaseFallThru.MAYBE_FALLS_THRU.equals(caseFallThru)`
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
      } else {
...
### UNUSED_IMPORT
Unused import `import static com.google.errorprone.util.ASTHelpers.isSameType;`
in `core/src/main/java/com/google/errorprone/bugpatterns/AvoidObjectArrays.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-03-10-51-41.410.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
