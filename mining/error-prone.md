...
# Bad smells
I found 1798 bad smells with 26 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 283 | false |
| DataFlowIssue | 276 | false |
| UnstableApiUsage | 224 | false |
| UnnecessaryFullyQualifiedName | 199 | false |
| AbstractClassNeverImplemented | 192 | false |
...
| NonShortCircuitBoolean | 13 | false |
...
### DataFlowIssue
Method invocation `getQualifiedName` may produce `NullPointerException`
in `core/src/main/java/com/google/errorprone/bugpatterns/BoxedPrimitiveEquality.java`
#### Snippet
```java
...
in `check_api/src/main/java/com/google/errorprone/scanner/ScannerSupplierImpl.java`
#### Snippet
```java
    try {
