...
# Bad smells
I found 1857 bad smells with 27 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| DataFlowIssue | 369 | false |
| BoundedWildcard | 287 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-28-13-25-18.397.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
