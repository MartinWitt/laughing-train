...
# Bad smells
I found 1905 bad smells with 27 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| DataFlowIssue | 367 | false |
| BoundedWildcard | 284 | false |
| UnstableApiUsage | 227 | false |
| UnnecessaryFullyQualifiedName | 199 | false |
| AbstractClassNeverImplemented | 194 | false |
| AssignmentToMethodParameter | 77 | false |
| RedundantFieldInitialization | 49 | false |
| SimplifyOptionalCallChains | 43 | false |
| Convert2Lambda | 39 | false |
...
### NonShortCircuitBoolean
Non-short-circuit boolean expression `hasDefaultCase |= isDefaultCase`
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
...
### NonShortCircuitBoolean
Non-short-circuit boolean expression `allCasesHaveDefiniteControlFlow &= !fallsIntoDefaultCase`
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
...
### NonShortCircuitBoolean
Non-short-circuit boolean expression `allCasesHaveDefiniteControlFlow &= !fallsIntoDefaultCase && caseFall...`
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
          allCasesHaveDefiniteControlFlow &= !fallsIntoDefaultCase;
...
### NonShortCircuitBoolean
Non-short-circuit boolean expression `allCasesHaveDefiniteControlFlow &= !caseFallThru.equals(CaseFallThru.MAYBE_FALLS_THRU)`
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
      } else {
...
in `check_api/src/main/java/com/google/errorprone/scanner/ErrorProneInjector.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `AssignmentSwitchAnalysisState` has no concrete subclass
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `AssignmentSwitchAnalysisResult` has no concrete subclass
in `core/src/main/java/com/google/errorprone/bugpatterns/StatementSwitchToExpressionSwitch.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `PostfixInsertion` has no concrete subclass
in `check_api/src/main/java/com/google/errorprone/fixes/SuggestedFix.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `ReplacementFix` has no concrete subclass
in `check_api/src/main/java/com/google/errorprone/fixes/SuggestedFix.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `SuggestedFix` has no concrete subclass
in `check_api/src/main/java/com/google/errorprone/fixes/SuggestedFix.java`
#### Snippet
```java
 */
...
### AbstractClassNeverImplemented
Abstract class `PrefixInsertion` has no concrete subclass
in `check_api/src/main/java/com/google/errorprone/fixes/SuggestedFix.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `InsertionFix` has no concrete subclass
in `check_api/src/main/java/com/google/errorprone/fixes/SuggestedFix.java`
#### Snippet
```java
...
### EmptyMethod
All implementations of this method are empty
in `check_api/src/main/java/com/google/errorprone/fixes/Fix.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-03-19-02-12-18.025.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### UnnecessaryFullyQualifiedName
Qualifier `java.util` is unnecessary, and can be replaced with an import
in `core/src/main/java/com/google/errorprone/bugpatterns/threadsafety/WellKnownThreadSafety.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `java.util.concurrent.locks` is unnecessary, and can be replaced with an import
in `core/src/main/java/com/google/errorprone/bugpatterns/threadsafety/WellKnownThreadSafety.java`
#### Snippet
```java
            .add(java.util.concurrent.Semaphore.class)
...
in `core/src/main/java/com/google/errorprone/bugpatterns/StringCaseLocaleUsage.java`
#### Snippet
```java
    }
