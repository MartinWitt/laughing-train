...
# Bad smells
I found 112 bad smells with 0 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| GroovyUnusedAssignment | 111 | false |
...
description = 'Detects unauthenticated Redis allowing RCE.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami detector for Joomla Rusty RCE.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami detector for Joomla CVE-2015-8562.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami Ghostcat detector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami Java JMX RCE VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'CVE-2012-1823 Tsunami detector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami Confluence CVE-2022-26134 RCE VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
### GroovyUnusedAssignment
Assignment is not used
in `google/detectors/rce/cve20199193/build.gradle`
#### Snippet
```java
}

description = 'Tsunami CVE-2019-9193 VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2018-7600 VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2021-21972 VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2019-6340 VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2021-41773 VulnDetector plugin with payload generator.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for exposed Hadoop Yarn API.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for exposed Spring Boot Actuator endpoints.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for exposed Jenkins UI.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for exposed vulnerable eval-stdin.php in phpunit.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami Kubernetes API Exposed VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami detector for Apache NiFi API.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami Elasticsearch API exposed VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Exposed Argo Workflow instances VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami NodeRedDashboard DirectoryTraversal VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for weak credential detection using ncrack.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami VulnDetector plugin for Cisco SMI.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2021-22205 VulnDetector plugin.'
group 'com.google.tsunami'
version '0.0.1-SNAPSHOT'
```
...
### GroovyUnusedAssignment
Assignment is not used
in `community/detectors/influxdb_cve_2019_20933/build.gradle`
#### Snippet
```java
}

description = 'Tsunami CVE-2019-20933 VulnDetector plugin.'
group 'com.google.tsunami'
version '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2020-14882 VulnDetector plugin.'
group 'com.google.tsunami'
version '0.0.1-SNAPSHOT'
```
...
description = 'Tsunami CVE-2021-40539 VulnDetector plugin.'
group 'com.google.tsunami'
version '0.0.1-SNAPSHOT'
```
...
### GroovyUnusedAssignment
Assignment is not used
in `community/detectors/spring_cloud_function_cve_2022_22963/build.gradle`
#### Snippet
```java
}

description = 'Tsunami CVE-2022-22963 VulnDetector plugin.'
group = 'com.google.tsunami'
version = '0.0.1-SNAPSHOT'
```
...
<script async="true" src="/static/5e16d1d1/scripts/svgxuse.min.js" type="text/javascript"></script>
</body>
</html>
```
