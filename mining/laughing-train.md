...
# Bad smells
I found 132 bad smells with 10 repairable:
...
in `code-transformation/src/main/java/xyz/keksdose/spoon/code_solver/diffs/DiffCleaner.java`
#### Snippet
```java
                    return LF;
                } else if (c == '\r') {
...
### BoundedWildcard
Can generalize to `? extends DiffEntry`
in `code-transformation/src/main/java/xyz/keksdose/spoon/code_solver/diffs/DiffCleaner.java`
#### Snippet
```java
    }
