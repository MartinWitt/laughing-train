...
### ObsoleteCollection
Obsolete collection type `Hashtable<>` used
in `corpus-server/corpus-server-impl/src/main/java/org/apache/opennlp/corpus_server/impl/Activator.java`
#### Snippet
```java
    corpusServer.start();
...
### RedundantArrayCreation
Redundant array creation for calling varargs method
in `opennlp-similarity/src/main/java/opennlp/tools/nl2code/ObjectPhrase.java`
#### Snippet
```java
...
Iteration over `docsWithClass.keySet()` may be replaced with 'entrySet()' iteration
in `nlp-utils/src/main/java/org/apache/opennlp/utils/classification/SimpleNaiveBayesClassifier.java`
#### Snippet
```java
...
### KeySetIterationMayUseEntrySet
Iteration over `mockClassMegaDocMap.keySet()` may be replaced with 'entrySet()' iteration
in `nlp-utils/src/main/java/org/apache/opennlp/utils/classification/SimpleNaiveBayesClassifier.java`
#### Snippet
```java
      }
...
### KeySetIterationMayUseEntrySet
Iteration over `corpusIndexerMap.keySet()` may be replaced with 'values()' iteration
...
### KeySetIterationMayUseEntrySet
Iteration over `corpusSearcherMap.keySet()` may be replaced with 'entrySet()' iteration
in `corpus-server/corpus-server-impl/src/main/java/org/apache/opennlp/corpus_server/impl/LuceneSearchService.java`
#### Snippet
```java
    }
...
### KeySetIterationMayUseEntrySet
Iteration over `pronounMap.keySet()` may be replaced with 'entrySet()' iteration
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/ResolverUtils.java`
#### Snippet
```java
...
### KeySetIterationMayUseEntrySet
Iteration over `extraFields.keySet()` may be replaced with 'entrySet()' iteration
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/IterativeSearchRequestHandler.java`
#### Snippet
```java
				}
...
### KeySetIterationMayUseEntrySet
Iteration over `uniqueTokens.keySet()` may be replaced with 'entrySet()' iteration
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/TextProcessor.java`
#### Snippet
```java
      }
...
Qualifier `TaskQueueView` on 'this' is unnecessary in this context
...
### UnnecessaryQualifierForThis
Qualifier `CorpusExplorerView` on 'this' is unnecessary in this context
...
Multiple occurrences of `title.replace(' ','_').replace('\"', ' ').trim()`
...
### DuplicateExpressions
Multiple occurrences of `strings1.length + strings2.length - 2 * intersectNum`
...
### DuplicateExpressions
Multiple occurrences of `Character.isDigit(str2.charAt(j - 1))`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/LevensteinDistanceFinder.java`
#### Snippet
```java
...
### DuplicateExpressions
Multiple occurrences of `Character.isDigit(str1.charAt(i - 1))`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/LevensteinDistanceFinder.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`ctoks.size() == 0` can be replaced with 'ctoks.isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/PTBHeadFinder.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`toks.size() == 0` can be replaced with 'toks.isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/PTBHeadFinder.java`
#### Snippet
```java
    }
...
### SizeReplaceableByIsEmpty
`kids.size() > 0` can be replaced with '!kids.isEmpty()'
...
### SizeReplaceableByIsEmpty
`np.getNounPhrases().size() == 0` can be replaced with 'np.getNounPhrases().isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/AbstractMentionFinder.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`documents.size() > 0` can be replaced with '!documents.isEmpty()'
...
### SizeReplaceableByIsEmpty
`ec.getSynsets().size() == 0` can be replaced with 'ec.getSynsets().isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/sim/SimilarityModel.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`cec.getSynsets().size() == 0` can be replaced with 'cec.getSynsets().isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/sim/SimilarityModel.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`synsets1.size() == 0` can be replaced with 'synsets1.isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/sim/SimilarityModel.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`synsets2.size() == 0` can be replaced with 'synsets2.isEmpty()'
in `opennlp-coref/src/main/java/opennlp/tools/coref/sim/SimilarityModel.java`
#### Snippet
```java
      return features;
...
### SizeReplaceableByIsEmpty
`cList.get(k).extent.size()==0` can be replaced with 'cList.get(k).extent.isEmpty()'
...
### SizeReplaceableByIsEmpty
`conceptList.get(curNode).parents.size()>0` can be replaced with '!conceptList.get(curNode).parents.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/fca/ConceptLattice.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`union.size() > 0` can be replaced with '!union.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/fca/BasicLevelMetrics.java`
#### Snippet
```java
		unionOut.removeAll(union);	
...
### SizeReplaceableByIsEmpty
`wordRes.size() > 0` can be replaced with '!wordRes.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/StoryDiscourseNavigator.java`
#### Snippet
```java
			}
...
### SizeReplaceableByIsEmpty
`map1.size() > 0` can be replaced with '!map1.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`map2.size() > 0` can be replaced with '!map2.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
		Map<String, Integer> map1 = null; //LastFM_APIManager.extractTagsForArtist(name1);
...
### SizeReplaceableByIsEmpty
`this.getFragments().size() > 0` can be replaced with '!this.getFragments().isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/HitBase.java`
#### Snippet
```java
		// return "\n"+this.getUrl()+" | " +this.getTitle()+ " | "+
...
### SizeReplaceableByIsEmpty
`fq.trim().length()!=0` can be replaced with '!fq.trim().isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/IterativeQueryComponent.java`
#### Snippet
```java
			}
...
### SizeReplaceableByIsEmpty
`cleanedRes.size() > 0` can be replaced with '!cleanedRes.isEmpty()'
...
### SizeReplaceableByIsEmpty
`psPos.conceptList.get(iConcept).intent.size()>0` can be replaced with '!psPos.conceptList.get(iConcept).intent.isEmpty()'
...
### SizeReplaceableByIsEmpty
`reduceList(intersection).size()>0` can be replaced with '!reduceList(intersection).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeWithDeduction.java`
#### Snippet
```java
			if (psPos.conceptList.get(iConcept).intent!=null && psPos.conceptList.get(iConcept).intent.size()>0){
...
### SizeReplaceableByIsEmpty
`psNeg.conceptList.get(iConcept).intent.size()>0` can be replaced with '!psNeg.conceptList.get(iConcept).intent.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeWithDeduction.java`
#### Snippet
```java
		}
...
### SizeReplaceableByIsEmpty
`clausesBodiesToAdd.size()>0` can be replaced with '!clausesBodiesToAdd.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeWithDeduction.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`newGroup.size()>0` can be replaced with '!newGroup.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeBase.java`
#### Snippet
```java
						newGroup.add(ch);
...
### SizeReplaceableByIsEmpty
`memberList.size()>0` can be replaced with '!memberList.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeBase.java`
#### Snippet
```java
					memberList.add(newGroup);
...
### SizeReplaceableByIsEmpty
`conceptList.get(k).extent.size() == 0` can be replaced with 'conceptList.get(k).extent.isEmpty()'
...
### SizeReplaceableByIsEmpty
`classifResults.size() > 0` can be replaced with '!classifResults.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifier.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`childText.length() == 0` can be replaced with 'childText.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/PhraseNode.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`childrenNodeList.size() > 0` can be replaced with '!childrenNodeList.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`paragraphParses.size() == 0` can be replaced with 'paragraphParses.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`paragraphNodes.size() > 0` can be replaced with '!paragraphNodes.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
    }
...
### SizeReplaceableByIsEmpty
`textParses.size() == 0` can be replaced with 'textParses.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`textNodes.size() > 0` can be replaced with '!textNodes.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
    }
...
### SizeReplaceableByIsEmpty
`paragraph.length() == 0` can be replaced with 'paragraph.isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserChunker2MatcherProcessor.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`attrs.keySet().size()>0` can be replaced with '!attrs.keySet().isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`chunks.get(0).size() > 0` can be replaced with '!chunks.get(0).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
...
### SizeReplaceableByIsEmpty
`chunks.get(1).size() > 0` can be replaced with '!chunks.get(1).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
			buf.append(" np ").append(chunks.get(0).toString());
...
### SizeReplaceableByIsEmpty
`chunks.get(2).size() > 0` can be replaced with '!chunks.get(2).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
			return buf.toString();
...
### SizeReplaceableByIsEmpty
`chunks.get(3).size() > 0` can be replaced with '!chunks.get(3).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
			buf.append(" prp ").append(chunks.get(2).toString());
...
### SizeReplaceableByIsEmpty
`chunks.get(4).size() > 0` can be replaced with '!chunks.get(4).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
			buf.append(" pp ").append(chunks.get(3).toString());
...
### SizeReplaceableByIsEmpty
`chunks.get(5).size() > 0` can be replaced with '!chunks.get(5).isEmpty()'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
			buf.append(" adjp ").append(chunks.get(4).toString());
...
Contents of `StringBuilder buf` are updated, but never queried
...
### MismatchedStringBuilderQueryUpdate
Contents of `StringBuilder bufNums` are updated, but never queried
...
Abstract class `NoisyChannel` has no concrete subclass
in `nlp-utils/src/main/java/org/apache/opennlp/utils/languagemodel/NoisyChannel.java`
#### Snippet
```java
...
in `opennlp-coref/src/main/java/opennlp/tools/lang/english/CorefParse.java`
#### Snippet
```java
...
### BoundedWildcard
Can generalize to `? extends CorefSample`
in `opennlp-coref/src/main/java/opennlp/tools/coref/CorefTrainer.java`
#### Snippet
```java
  }
...
### BoundedWildcard
Can generalize to `? extends HitBase`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/BingWebQueryRunner.java`
#### Snippet
```java
...
### MissortedModifiers
Missorted modifiers `final static`
in `corpus-server/corpus-server-impl/src/main/java/org/apache/opennlp/corpus_server/impl/DerbyCorpusStore.java`
#### Snippet
```java
...
### MissortedModifiers
Missorted modifiers `static public`
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/EpistemicStatesTrainingSet.java`
#### Snippet
```java
...
`equals` between objects of inconvertible types 'Word' and 'String'
...
### DuplicateCondition
Duplicate condition `tok.equals("these")`
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/ResolverUtils.java`
#### Snippet
```java
...
### DuplicateCondition
Duplicate condition `sentTry.contains("click here")`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
      return null;
...
### DuplicateCondition
Duplicate condition `sentTry.contains("permission is granted")`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
...
### DuplicateCondition
Duplicate condition `sentTry.contains("chat live")`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
        || sentTry.contains("mailing list") || sentTry.contains("purchase order")
...
### DuplicateCondition
Duplicate condition `sentTry.startsWith( "fax")`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
        || sentTry.contains("click here") || sentTry.contains("for details") || sentTry.contains("assistance?") || sentTry.contains("chat live")
...
### DuplicateCondition
Duplicate condition `feature.startsWith("View Larger")`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/WebPageReviewExtractor.java`
#### Snippet
```java
		List<String> results = new ArrayList<>();
...
### DuplicateCondition
Duplicate condition `name1.endsWith(name2)`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
...
### DuplicateCondition
Duplicate condition `name1.contains(name2)`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
		name2 = name2.toLowerCase();
...
### DuplicateCondition
Duplicate condition `name1.startsWith(name2r)`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
			return 2;
...
### DuplicateCondition
Duplicate condition `name1.endsWith(name2r)`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
			return 2;
...
### DuplicateCondition
Duplicate condition `name1r.endsWith(name2r)`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
			return 1;
...
### IfStatementMissingBreakInLoop
Loop can be terminated after condition is met
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/SentencePairMatchResult.java`
#### Snippet
```java
...
### IfStatementMissingBreakInLoop
Loop can be terminated after condition is met
in `opennlp-similarity/src/main/java/opennlp/tools/enron_email_recognizer/EmailNormalizer.java`
#### Snippet
```java
			boolean bAccept = true;
...
### IfStatementMissingBreakInLoop
Loop can be terminated after condition is met
in `opennlp-similarity/src/main/java/opennlp/tools/enron_email_recognizer/EmailTrainingSetFormer.java`
#### Snippet
```java
			boolean bAccept = true;
...
### IgnoreResultOfCall
Result of `BigInteger.add()` is ignored
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/WordDocBuilderEndNotes.java`
#### Snippet
```java
...
### RedundantMethodOverride
Method `buildLearningModel()` only delegates to its super method
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeWithAbduction.java`
#### Snippet
```java
...
### RedundantMethodOverride
Method `assessRelevance()` is identical to its super method
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserPure2MatcherProcessor.java`
#### Snippet
```java
  }
...
### UNUSED_IMPORT
Unused import `import org.eclipse.jface.viewers.IOpenListener;`
in `caseditor-corpus-server-plugin/src/main/java/org/apache/opennlp/corpus_server/caseditor/CorpusExplorerView.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.eclipse.jface.viewers.OpenEvent;`
in `caseditor-corpus-server-plugin/src/main/java/org/apache/opennlp/corpus_server/caseditor/CorpusExplorerView.java`
#### Snippet
```java
import org.eclipse.jface.viewers.IOpenListener;
...
### UNUSED_IMPORT
Unused import `import org.eclipse.swt.events.ModifyEvent;`
in `caseditor-corpus-server-plugin/src/main/java/org/apache/opennlp/corpus_server/caseditor/CorpusExplorerView.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.eclipse.swt.events.ModifyListener;`
in `caseditor-corpus-server-plugin/src/main/java/org/apache/opennlp/corpus_server/caseditor/CorpusExplorerView.java`
#### Snippet
```java
import org.eclipse.swt.events.KeyListener;
...
### UNUSED_IMPORT
Unused import `import org.eclipse.jface.dialogs.IInputValidator;`
...
### UNUSED_IMPORT
Unused import `import org.eclipse.swt.widgets.Event;`
in `caseditor-opennlp-plugin/src/main/java/org/apache/opennlp/caseditor/namefinder/ConfirmedNameDetectionFieldEditor.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.eclipse.swt.widgets.Listener;`
in `caseditor-opennlp-plugin/src/main/java/org/apache/opennlp/caseditor/namefinder/ConfirmedNameDetectionFieldEditor.java`
#### Snippet
```java
import org.eclipse.swt.widgets.Event;
...
### UNUSED_IMPORT
Unused import `import org.eclipse.jface.viewers.ISelectionChangedListener;`
...
### UNUSED_IMPORT
Unused import `import org.eclipse.jface.viewers.SelectionChangedEvent;`
in `caseditor-opennlp-plugin/src/main/java/org/apache/opennlp/caseditor/namefinder/NameFinderViewPage.java`
#### Snippet
```java
import org.eclipse.jface.viewers.ISelection;
...
### UNUSED_IMPORT
Unused import `import java.io.FileFilter;`
...
### ReplaceAssignmentWithOperatorAssignment
`pageSentence = pageSentence + ". "` could be simplified to 'pageSentence += ". "'
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
...
### ReplaceAssignmentWithOperatorAssignment
`flags = flags + flagToCheck` could be simplified to 'flags += flagToCheck'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/Utils.java`
#### Snippet
```java
    }
...
### ReplaceAssignmentWithOperatorAssignment
`score = score+0.0000001f` could be simplified to 'score += 0.0000001f'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/FeatureSpaceCoverageProcessor.java`
#### Snippet
```java
...
### ReplaceAssignmentWithOperatorAssignment
`score = score+0.01f` could be simplified to 'score += 0.01f'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/FeatureSpaceCoverageProcessor.java`
#### Snippet
```java
				score = score+0.0000001f;
...
Contents of collection `keys` are updated, but never queried
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SearchResultsReRankerRequestHandler.java`
#### Snippet
```java
...
### MismatchedCollectionQueryUpdate
Contents of collection `reportData` are updated, but never queried
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/apps/MultiSentenceSearchResultsProcessor.java`
#### Snippet
```java
...
### MismatchedCollectionQueryUpdate
Contents of collection `commonPOS` are updated, but never queried
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/PhraseGeneralizer.java`
#### Snippet
```java
...
### MismatchedCollectionQueryUpdate
Contents of collection `commonLemmas` are updated, but never queried
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/PhraseGeneralizer.java`
#### Snippet
```java
...
### MismatchedCollectionQueryUpdate
Contents of collection `sbarp` are updated, but never queried
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
	public List<List<ParseTreeChunk>> groupChunksAsParses(
...
Field `nameList` is accessed in both synchronized and unsynchronized contexts
...
### FieldAccessedSynchronizedAndUnsynchronized
Field `sentenceType` is accessed in both synchronized and unsynchronized contexts
in `caseditor-opennlp-plugin/src/main/java/org/apache/opennlp/caseditor/sentdetect/SentenceDetectorJob.java`
#### Snippet
```java
  private String text;
...
in `corpus-server/corpus-server-core/src/main/java/org/apache/opennlp/corpus_server/search/SearchService.java`
#### Snippet
```java
...
### EmptyMethod
All implementations of this method are empty
in `opennlp-wsd/src/main/java/opennlp/tools/cmdline/disambiguator/DisambiguatorToolParams.java`
#### Snippet
```java
...
in `nlp-utils/src/main/java/org/apache/opennlp/utils/classification/UpdatableSimpleNaiveBayesClassifier.java`
#### Snippet
```java
...
### RedundantFieldInitialization
Field initialization to `null` is redundant
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/taxo_builder/CsvAdapter.java`
#### Snippet
```java
...
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/datareader/Word.java`
#### Snippet
```java
...
in `opennlp-wsd/src/main/java/opennlp/tools/cmdline/disambiguator/DisambiguatorEvaluatorParams.java`
#### Snippet
```java
...
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/cgRequestForm.html`
#### Snippet
```java
...
### ZeroLengthArrayInitialization
Allocation of zero length array
in `caseditor-opennlp-plugin/src/main/java/org/apache/opennlp/caseditor/sentdetect/SentenceContentProvider.java`
#### Snippet
```java
  @Override
...
### ZeroLengthArrayInitialization
Allocation of zero length array
in `corpus-server/corpus-server-connector/src/main/java/org/apache/opennlp/corpus_server/connector/CSQueueCollectionReader.java`
#### Snippet
```java
  @Override
...
### ZeroLengthArrayInitialization
Allocation of zero length array
in `tagging-server/src/main/java/org/apache/opennlp/tagging_server/namefind/BratNameFinderResource.java`
#### Snippet
```java
...
### ZeroLengthArrayInitialization
Allocation of zero length array
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/IMSWSDContextGenerator.java`
#### Snippet
```java
    }
    String[] res;
...
### UnusedAssignment
The value `this.samples.read()` assigned to `sample` is never used
in `opennlp-dl/src/main/java/opennlp/tools/dl/NameSampleDataSetIterator.java`
#### Snippet
```java
...
### UnusedAssignment
The value `1` assigned to `mult1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/fca/Measures.java`
#### Snippet
```java
			for (int k=0; k<= n; k++){
				mult = 1;
...
### UnusedAssignment
The value `filter.getSynonym("yell")` assigned to `syn` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymListFilter.java`
#### Snippet
```java
...
### UnusedAssignment
The value `"Page 2 of 93"` assigned to `para` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/GeneratedSentenceProcessor.java`
#### Snippet
```java
...
### UnusedAssignment
The value `ParserChunker2MatcherProcessor.getInstance()` assigned to `sm` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/ContentGeneratorRunner.java`
#### Snippet
```java
				sm = ParserChunker2MatcherProcessor.getInstance(resourceDir);
...
### UnusedAssignment
The value `null` assigned to `buffer` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
...
### UnusedAssignment
The value `null` assigned to `buf` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
...
### UnusedAssignment
The value `null` assigned to `words` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
...
### UnusedAssignment
The value `null` assigned to `allSynonyms` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
   if (DEBUG) {
...
### UnusedAssignment
The value `null` assigned to `internedWords` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
     words = null;
...
### UnusedAssignment
The value `null` assigned to `allWords` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
     allSynonyms = null;
...
### UnusedAssignment
The value `null` assigned to `word2Groups` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
...
### UnusedAssignment
The value `null` assigned to `group2Words` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SynonymMap.java`
#### Snippet
```java
   word2Groups = null; // help gc
...
### UnusedAssignment
The value `s.replaceAll("[a-z] [A-Z]", ". $1")` assigned to `sr` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/ContentGeneratorSupport.java`
#### Snippet
```java
...
### UnusedAssignment
The value `s.replaceAll(" [A-Z]", ". $1")` assigned to `sr1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/ContentGeneratorSupport.java`
#### Snippet
```java
		String sr1 = s.replaceAll("  [A-Z]", ". $0");
...
### UnusedAssignment
The value `getFullOriginalSentenceFromWebpageBySnippetFragment(
fragment.replace("_should_find_orig_", ""), sents)` assigned to `mainAndFollowSent` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/RelatedSentenceFinderML.java`
#### Snippet
```java
...
### UnusedAssignment
The value `values.getName(1)` assigned to `k1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
...
### UnusedAssignment
The value `values.getName(2)` assigned to `k1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
		String k1 = values.getName(0);
...
### UnusedAssignment
The value `values.getName(3)` assigned to `k1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
		k1 = values.getName(1);
...
### UnusedAssignment
The value `values.getName(4)` assigned to `k1` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
		k1 = values.getName(2);
...
### UnusedAssignment
The value `filterResultsBySyntMatchReduceDocSet(dList, req, req.getParams())` assigned to `dListResult` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
		DocList dListResult;
...
### UnusedAssignment
The value `dList` assigned to `dListResult` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/SyntGenRequestHandler.java`
#### Snippet
```java
			dListResult = filterResultsBySyntMatchReduceDocSet(dList, req,  req.getParams());
...
### UnusedAssignment
The value `args[0]` assigned to `runner.sourceDir` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifierTrainingSetVerifier.java`
#### Snippet
```java
...
### UnusedAssignment
The value `args[1]` assigned to `runner.destinationDir` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifierTrainingSetVerifier.java`
#### Snippet
```java
...
### UnusedAssignment
The value changed at `z++` is never used
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/GeneralizationListReducer.java`
#### Snippet
```java
...
in `tf-ner-poc/src/main/java/org/apache/opennlp/namefinder/FeedDictionary.java`
#### Snippet
```java
...
### ConstantValue
Condition `"add".equals(action)` is always `false`
in `corpus-server/corpus-server-connector/src/main/java/org/apache/opennlp/corpus_server/connector/CSCasWriter.java`
#### Snippet
```java
...
### ConstantValue
Condition `"update".equals(action)` is always `true`
in `corpus-server/corpus-server-connector/src/main/java/org/apache/opennlp/corpus_server/connector/CSCasWriter.java`
#### Snippet
```java
...
### ConstantValue
Condition `array1.equals(null)` is always `false`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/WSDHelper.java`
#### Snippet
```java
...
### ConstantValue
Condition `array1.equals(null) || array2.equals(null)` is always `false`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/WSDHelper.java`
#### Snippet
```java
  public static boolean areStringArraysEqual(String[] array1, String[] array2) {
...
### ConstantValue
Condition `array2.equals(null)` is always `false` when reached
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/WSDHelper.java`
#### Snippet
```java
  public static boolean areStringArraysEqual(String[] array1, String[] array2) {
...
### ConstantValue
Condition `k<=newAttrCount` is always `true` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/fca/FcaConverter.java`
#### Snippet
```java
		run = true;
...
### ConstantValue
Condition `fragment.resultText != null` is always `true` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/apps/contentgen/multithreaded/Fragment.java`
#### Snippet
```java
...
### ConstantValue
Condition `resultText != null` is always `true` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/apps/contentgen/multithreaded/Fragment.java`
#### Snippet
```java
		if (resultText == null && fragment.resultText == null) {
...
### ConstantValue
Condition `correct && vault` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/EmailSender.java`
#### Snippet
```java
			if(correct){
...
### ConstantValue
Condition `correct` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/EmailSender.java`
#### Snippet
```java
			if(correct){
...
### ConstantValue
Condition `vault` is always `false` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/EmailSender.java`
#### Snippet
```java
			if(correct){
...
### ConstantValue
Condition `objectsSimilaritySMC == null` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/fca/BasicLevelMetrics.java`
#### Snippet
```java
...
### ConstantValue
Condition `resourceDir ==null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/word2vec/W2VDistanceMeasurer.java`
#### Snippet
```java
...
### ConstantValue
Condition `fragment.resultText != null` is always `true` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/Fragment.java`
#### Snippet
```java
    if (resultText == null && fragment.resultText == null) {
      return true;
...
### ConstantValue
Condition `pageSentence == null` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/GeneratedSentenceProcessor.java`
#### Snippet
```java
			return "";
...
### ConstantValue
Condition `keywordsFromWikipedia!=null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/StoryDiscourseNavigator.java`
#### Snippet
```java
...
### ConstantValue
Condition `map1 != null && map2 != null && map1.size() > 0 && map2.size() > 0` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
		Map<String, Integer> map1 = null; //LastFM_APIManager.extractTagsForArtist(name1);
...
### ConstantValue
Condition `srchResArea == null` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/WebSearchEngineResultsScraper.java`
#### Snippet
```java
      return results;
...
### ConstantValue
Result of `hits.size()` is always '0'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/WebSearchEngineResultsScraper.java`
#### Snippet
```java
    } */
...
### ConstantValue
Condition `followSent != null` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/RelatedSentenceFinderML.java`
#### Snippet
```java
...
### ConstantValue
Condition `tmp != null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/Utils.java`
#### Snippet
```java
...
### ConstantValue
Condition `ps != null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/LemmaGeneralizer.java`
#### Snippet
```java
...
### ConstantValue
Condition `chunkToAdd != null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/PhraseGroupGeneralizer.java`
#### Snippet
```java
          }
...
### ConstantValue
Condition `occur1!=null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/NERPhraseGeneralizer.java`
#### Snippet
```java
			else {
...
### ConstantValue
Condition `occur2!=null` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/NERPhraseGeneralizer.java`
#### Snippet
```java
			else {
...
### ConstantValue
Condition `lemmas==null` is always `false`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/communicative_actions/CommunicativeActionsArcBuilder.java`
#### Snippet
```java
...
### ConstantValue
Condition `indexIN - 1 > 0` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeMatcher.java`
#### Snippet
```java
        ch.getLemmas().size());
...
### ConstantValue
Condition `idx < 45` is always `true` when reached
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/TextProcessor.java`
#### Snippet
```java
...
### ConstantValue
Condition `firstIdx != -1` is always `true`
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/TextProcessor.java`
#### Snippet
```java
      }
...
Method 'contains()' always returns false: the argument contains an uppercase symbol while the qualifier is lowercase-only
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
...
### MismatchedStringCase
Method 'startsWith()' always returns false: the argument contains an uppercase symbol while the qualifier is lowercase-only
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
        || sentTry.contains("clicking here")
...
in `mallet-addon/src/main/java/opennlp/addons/mallet/ClassifierModelSerializer.java`
#### Snippet
```java
  @Override
...
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/apps/MostFrequentWordsFromPageGetter.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `NUM_SENTS_BACK_PRONOUNS` may be 'static'
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/PluralPronounResolver.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `translatorURL` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MachineTranslationWrapper.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `MAX_QUERY_LENGTH` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/BingQueryRunner.java`
#### Snippet
```java
	}
...
### FieldMayBeStatic
Field `MAX_QUERY_LENGTH_NOT_TO_RERANK` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/NLProgram2CodeRequestHandler.java`
#### Snippet
```java
	private final static int MAX_SEARCH_RESULTS = 100;
...
### FieldMayBeStatic
Field `MIN_STRING_LENGTH_FOR_DISTORTED_WORD` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/StringDistanceMeasurer.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `percentageOfAllowedSetCover` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/IntersectionSetBuilder.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `CAT_COMPUTING` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifier.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `FRAGMENT_LENGTH` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifierTrainingSetMultilingualExtender.java`
#### Snippet
```java
...
### FieldMayBeStatic
Field `origFolder` may be 'static'
in `opennlp-similarity/src/main/java/opennlp/tools/enron_email_recognizer/EmailTrainingSetFormer.java`
#### Snippet
```java
	}
...
### UtilityClassWithoutPrivateConstructor
Class `CFGRunner` has only 'static' members, and lacks a 'private' constructor
in `nlp-utils/src/main/java/org/apache/opennlp/utils/cfg/CFGRunner.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `NGramUtils` has only 'static' members, and lacks a 'private' constructor
in `nlp-utils/src/main/java/org/apache/opennlp/utils/ngram/NGramUtils.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `CorefTrainer` has only 'static' members, and lacks a 'private' constructor
in `opennlp-coref/src/main/java/opennlp/tools/coref/CorefTrainer.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `DictionaryFactory` has only 'static' members, and lacks a 'private' constructor
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/DictionaryFactory.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `DefaultModelBuilderUtil` has only 'static' members, and lacks a 'private' constructor
in `modelbuilder-addon/src/main/java/opennlp/addons/modelbuilder/DefaultModelBuilderUtil.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `ResolverUtils` has only 'static' members, and lacks a 'private' constructor
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/ResolverUtils.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `MinedSentenceProcessor` has only 'static' members, and lacks a 'private' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `GeneratedSentenceProcessor` has only 'static' members, and lacks a 'private' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/GeneratedSentenceProcessor.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `ContentGeneratorRunner` has only 'static' members, and lacks a 'private' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/ContentGeneratorRunner.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `ProfileReaderWriter` has only 'static' members, and lacks a 'private' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/ProfileReaderWriter.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `EpistemicStatesTrainingSet` has only 'static' members, and lacks a 'private' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/EpistemicStatesTrainingSet.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `ParserCacheSerializer` has only 'static' members, and lacks a 'private' constructor
...
### DataFlowIssue
Method invocation `getOriginalizedSentences` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/WebPageReviewExtractor.java`
#### Snippet
```java
...
### DataFlowIssue
Method invocation `readLine` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/WebSearchEngineResultsScraper.java`
#### Snippet
```java
      }
...
### DataFlowIssue
Method invocation `getQuery` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/IterativeQueryComponent.java`
#### Snippet
```java
		Query q = null;
...
### DataFlowIssue
Array access `pageSentsAndSnippet[1]` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/apps/MultiSentenceSearchResultsProcessor.java`
#### Snippet
```java
				}
...
### DataFlowIssue
Array access `LANGS[langIndex]` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifierTrainingSetMultilingualExtender.java`
#### Snippet
```java
						}
...
### DataFlowIssue
Dereference of `entries` may produce `NullPointerException`
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifierTrainingSetMultilingualExtender.java`
#### Snippet
```java
		}
...
Deprecated member 'TreebankLinker' is still used
in `opennlp-coref/src/main/java/opennlp/tools/lang/english/TreebankLinker.java`
#### Snippet
```java
 */
...
Non-serializable field 'embedder' in a Serializable class
in `opennlp-dl/src/main/java/opennlp/tools/dl/DataReader.java`
#### Snippet
```java
    private Map<String, Integer> labelToId;
...
### NonSerializableFieldInSerializableClass
Non-serializable field 'parseTreeMatcher' in a Serializable class
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunk.java`
#### Snippet
```java
	private int size;
...
### CatchMayIgnoreException
Empty `catch` block
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/FBOpenGraphSearchManager.java`
#### Snippet
```java
        	try {
...
Assignment to for-loop parameter `ci`
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/DefaultParse.java`
#### Snippet
```java
        kids.remove(ci);
...
### SuspiciousMethodCalls
'ArrayList' may not contain objects of type 'Integer'
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/pattern_structure/LinguisticPatternStructure.java`
#### Snippet
```java
				if (conceptList.get(k).extent.size() == 0)
...
### PublicFieldAccessedInSynchronizedContext
Non-private field `indexReader` accessed in synchronized context
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifier.java`
#### Snippet
```java
			}
...
### PublicFieldAccessedInSynchronizedContext
Non-private field `indexSearcher` accessed in synchronized context
in `opennlp-similarity/src/main/java/opennlp/tools/doc_classifier/DocClassifier.java`
#### Snippet
```java
			try {
...
### PublicFieldAccessedInSynchronizedContext
Non-private field `pinstance` accessed in synchronized context
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/ParserPure2MatcherProcessor.java`
#### Snippet
```java
...
Class `EpistemicStatesTrainingSet` has only 'static' members, and a 'public' constructor
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/EpistemicStatesTrainingSet.java`
#### Snippet
```java
import java.util.HashMap;
...
### SystemOutErr
Uses of `System.err` should probably be replaced with more robust logging
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/SpeechPronounResolver.java`
#### Snippet
```java
      }
      else {
...
Implicit call to 'toString()' on array `candidateSentences`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/YahooAnswersMiner.java`
#### Snippet
```java
			for (String fragment : allFragms) {
...
Condition 'tok.equals(...)' covered by subsequent condition 'tok.equals(...)'
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/ResolverUtils.java`
#### Snippet
```java
  public static boolean definiteArticle(String tok, String tag) {
...
in `nlp-utils/src/main/java/org/apache/opennlp/utils/languagemodel/LanguageModel.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `org.apache.opennlp.utils` is unnecessary and can be removed
in `nlp-utils/src/main/java/org/apache/opennlp/utils/anomalydetection/AnomalyDetectionUtils.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `org.apache.uima.caseditor.editor` is unnecessary and can be removed
in `caseditor-corpus-server-plugin/src/main/java/org/apache/opennlp/corpus_server/caseditor/DefaultCasDocumentProvider.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `opennlp.tools.tokenize` is unnecessary, and can be replaced with an import
in `opennlp-coref/src/main/java/opennlp/tools/lang/english/TreebankNameFinder.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `opennlp.tools.coref` is unnecessary and can be removed
...
### UnnecessaryFullyQualifiedName
Qualifier `opennlp.tools.coref.mention` is unnecessary and can be removed
in `opennlp-coref/src/main/java/opennlp/tools/coref/mention/DictionaryFactory.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `opennlp.tools.ml.model` is unnecessary and can be removed
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/MaxentResolver.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `javax.mail` is unnecessary, and can be replaced with an import
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/SMTPAuthenticator.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `javax.swing.event` is unnecessary, and can be replaced with an import
in `opennlp-similarity/src/main/java/opennlp/tools/apps/contentgen/multithreaded/BingWebQueryRunnerThread.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `org.apache.commons.lang` is unnecessary, and can be replaced with an import
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/Utils.java`
#### Snippet
```java
...
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/ParseTreeChunkComparable.java`
#### Snippet
```java
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.WSDHelper;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/MFS.java`
#### Snippet
```java
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.WSDParameters;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/MFS.java`
#### Snippet
```java
import net.sf.extjwnl.data.Word;
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.WSDSample;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/MFS.java`
#### Snippet
```java
import opennlp.tools.disambiguator.WSDHelper;
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.WSDisambiguator;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/MFS.java`
#### Snippet
```java
import opennlp.tools.disambiguator.WSDParameters;
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.WordPOS;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/MFS.java`
#### Snippet
```java
import opennlp.tools.disambiguator.WSDSample;
...
### SamePackageImport
Unnecessary import from the same package `import opennlp.tools.disambiguator.MFS;`
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/Lesk.java`
#### Snippet
```java
import java.util.List;
...
### NonProtectedConstructorInAbstractClass
Constructor `AbstractLinker()` of an abstract class should not be declared 'public'
in `opennlp-coref/src/main/java/opennlp/tools/coref/AbstractLinker.java`
#### Snippet
```java
...
### NonProtectedConstructorInAbstractClass
Constructor `AbstractResolver()` of an abstract class should not be declared 'public'
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/AbstractResolver.java`
#### Snippet
```java
...
### NonProtectedConstructorInAbstractClass
Constructor `SyntacticTreeNode()` of an abstract class should not be declared 'public'
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/SyntacticTreeNode.java`
#### Snippet
```java
...
### Java8MapApi
Can be replaced with single 'Map.computeIfAbsent' method call
in `opennlp-similarity/src/main/java/opennlp/tools/apps/relevanceVocabs/SentimentVocab.java`
#### Snippet
```java
...
Assignment to method parameter `floatPrecisionFormatString`
in `opennlp-dl/src/main/java/opennlp/tools/dl/GlobalVectors.java`
#### Snippet
```java
...
### AssignmentToMethodParameter
Assignment to method parameter `cc`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/EmailSender.java`
#### Snippet
```java
			}
...
### AssignmentToMethodParameter
Assignment to method parameter `bcc`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/utils/email/EmailSender.java`
#### Snippet
```java
			to = eliminateSpaces(to);
...
### AssignmentToMethodParameter
Assignment to method parameter `sentence`
in `opennlp-similarity/src/main/java/opennlp/tools/nl2code/NL2ObjCreateAssign.java`
#### Snippet
```java
...
### AssignmentToMethodParameter
Assignment to method parameter `prodName`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/SentenceOriginalizer.java`
#### Snippet
```java
...
### AssignmentToMethodParameter
Assignment to method parameter `pageSentence`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/review_builder/MinedSentenceProcessor.java`
#### Snippet
```java
    if (pageSentence == null)
...
### AssignmentToMethodParameter
Assignment to method parameter `rawExpr`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/GoogleAutoCompleteQueryRunner.java`
#### Snippet
```java
	public List<String> getAutoCompleteExpression(String rawExpr){
...
### AssignmentToMethodParameter
Assignment to method parameter `name1Tokens`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
		if (name1Tokens.indexOf("of") > 0 && name2Tokens.indexOf("of") > 0)
...
### AssignmentToMethodParameter
Assignment to method parameter `name2Tokens`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
		{
...
### AssignmentToMethodParameter
Assignment to method parameter `thresh`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/SimilarityAccessorBase.java`
#### Snippet
```java
...
### AssignmentToMethodParameter
Assignment to method parameter `str1`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/StringDistanceMeasurer.java`
#### Snippet
```java
    double result;
...
### AssignmentToMethodParameter
Assignment to method parameter `str2`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/utils/StringDistanceMeasurer.java`
#### Snippet
```java
    try {
...
### AssignmentToMethodParameter
Assignment to method parameter `req`
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/solr/IterativeSearchRequestHandler.java`
#### Snippet
```java
	public SolrQueryResponse runSearchIteration(SolrQueryRequest req, SolrQueryResponse rsp, String fieldToTry){
...
### AssignmentToMethodParameter
Assignment to method parameter `lemma1`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/LemmaFormManager.java`
#### Snippet
```java
      return null;
...
### AssignmentToMethodParameter
Assignment to method parameter `lemma2`
in `opennlp-similarity/src/main/java/opennlp/tools/parse_thicket/matching/LemmaFormManager.java`
#### Snippet
```java
    }
...
### AssignmentToMethodParameter
Assignment to method parameter `negTexts`
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeWithDeduction.java`
#### Snippet
```java
		if (separationKeywords!=null){ // re-sort by occurrence of separation keyword
...
### AssignmentToMethodParameter
Assignment to method parameter `numTabs`
in `opennlp-similarity/src/main/java/opennlp/tools/textsimilarity/chunker2matcher/PhraseNode.java`
#### Snippet
```java
    // output all the children
...
### ReturnNull
Return of `null`
in `tagging-server/src/main/java/org/apache/opennlp/tagging_server/ServiceUtil.java`
#### Snippet
```java
    }
    else {
...
### ReturnNull
Return of `null`
in `opennlp-coref/src/main/java/opennlp/tools/coref/CorefSampleDataStream.java`
#### Snippet
```java
    }
    else {
...
### ReturnNull
Return of `null`
in `opennlp-coref/src/main/java/opennlp/tools/formats/muc/ShallowParseCorefEnhancerStream.java`
#### Snippet
```java
    }
    else {
...
### ReturnNull
Return of `null`
in `opennlp-similarity/src/main/java/opennlp/tools/apps/object_dedup/DedupResult.java`
#### Snippet
```java
...
### UnnecessaryLocalVariable
Local variable `rv` is redundant
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/CommonNounResolver.java`
#### Snippet
```java
    String firstTok = mention.getFirstTokenText().toLowerCase();
...
### UnnecessaryLocalVariable
Local variable `rv` is redundant
in `opennlp-coref/src/main/java/opennlp/tools/coref/resolver/PluralNounResolver.java`
#### Snippet
```java
    String firstTok = mention.getFirstTokenText().toLowerCase();
    String firstTokTag = mention.getFirstToken().getSyntacticType();
...
### UnnecessaryLocalVariable
Local variable `ars` is redundant
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/BingQueryRunner.java`
#### Snippet
```java
		iq.doQuery();
...
### UnnecessaryLocalVariable
Local variable `requestUrl` is redundant
in `opennlp-similarity/src/main/java/opennlp/tools/similarity/apps/WebSearchEngineResultsScraper.java`
#### Snippet
```java
...
### UnnecessaryLocalVariable
Local variable `decision` is redundant
in `opennlp-similarity/src/main/java/opennlp/tools/jsmlearning/JSMLearnerOnLatticeBase.java`
#### Snippet
```java
		Boolean bPositiveClass = (float)posIntersectionsUnderNegLst.size()/(float)negIntersectionsUnderPosLst.size() > 1f;
...
Cast may be removed by changing the type of 'pos' to 'POS'
in `opennlp-wsd/src/main/java/opennlp/tools/disambiguator/WSDHelper.java`
#### Snippet
```java
    try {
