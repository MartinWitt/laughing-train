...
# Bad smells
I found 162 bad smells with 13 repairable:
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-16-11-56-55.023.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### UnusedAssignment
Variable `propertyColumnName` initializer `null` is redundant
in `src/main/java/org/apache/commons/dbutils/BeanProcessor.java`
#### Snippet
```java
