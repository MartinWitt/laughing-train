...
# Bad smells
I found 485 bad smells with 38 repairable:
...
| Java9UndeclaredServiceUsage | 1 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-11-27-19-10-59.785.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
