...
# Bad smells
I found 517 bad smells with 40 repairable:
...
### UNUSED_IMPORT
Unused import `import com.microsoft.gctoolkit.event.jvm.JVMTermination;`
in `IT/src/main/java/com/microsoft/gctoolkit/integration/shared/OneRuntimeAggregator.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import java.util.concurrent.ThreadPoolExecutor;`
in `api/src/main/java/com/microsoft/gctoolkit/io/GCLogFile.java`
#### Snippet
```java
import java.util.ServiceConfigurationError;
...
### EmptyMethod
The method is empty
in `IT/src/main/java/com/microsoft/gctoolkit/integration/aggregation/HeapOccupancyAfterCollectionAggregator.java`
#### Snippet
```java
    }
...
in `api/src/main/java/com/microsoft/gctoolkit/message/Channel.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-25-18-46-36.907.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### NonProtectedConstructorInAbstractClass
Constructor `UnifiedGCLogParser()` of an abstract class should not be declared 'public'
in `parser/src/main/java/com/microsoft/gctoolkit/parser/UnifiedGCLogParser.java`
#### Snippet
```java
