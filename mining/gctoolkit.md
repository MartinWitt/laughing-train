...
# Bad smells
I found 504 bad smells with 40 repairable:
...
### BoundedWildcard
Can generalize to `? extends Aggregator`
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-23-07-40-11.214.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
