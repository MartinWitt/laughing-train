...
# Bad smells
I found 222 bad smells with 42 repairable:
...
### DataFlowIssue
Method invocation `setHealthy` may produce `NullPointerException`
...
### ConstantValue
Value `sessionJob` is always 'null'
