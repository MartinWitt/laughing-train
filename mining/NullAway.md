...
# Bad smells
I found 152 bad smells with 18 repairable:
...
in `nullaway/src/main/java/com/uber/nullaway/handlers/LombokHandler.java`
#### Snippet
```java
...
### FieldMayBeFinal
Field `LOMBOK_GENERATED_ANNOTATION_NAME` may be 'final'
in `nullaway/src/main/java/com/uber/nullaway/handlers/LombokHandler.java`
#### Snippet
```java
public class LombokHandler extends BaseNoOpHandler {
...
### FieldMayBeFinal
Field `LOMBOK_BUILDER_DEFAULT_METHOD_PREFIX` may be 'final'
in `nullaway/src/main/java/com/uber/nullaway/handlers/LombokHandler.java`
#### Snippet
```java
