...
# Bad smells
I found 269 bad smells with 11 repairable:
...
in `core/src/main/java/de/jplag/reporting/reportobject/model/Version.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-27-23-30-23.318.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
