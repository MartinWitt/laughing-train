...
# Bad smells
I found 215 bad smells with 17 repairable:
...
### UNUSED_IMPORT
Unused import `import com.microsoft.kiota.http.ObservabilityOptions;`
in `components/http/okHttp/src/main/java/com/microsoft/kiota/http/middleware/ParametersNameDecodingHandler.java`
#### Snippet
```java
...
### UnusedAssignment
The value `new TelemetryHandlerOption()` assigned to `this._telemetryHandlerOption` is never used
