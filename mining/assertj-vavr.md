...
# Bad smells
I found 225 bad smells with 5 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| UnnecessaryFullyQualifiedName | 161 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-27-01-54-57.123.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### BoundedWildcard
Can generalize to `? super INVALID`
in `src/main/java/org/assertj/vavr/api/AbstractValidationAssert.java`
#### Snippet
```java
     * @throws AssertionError       if the actual value does not satisfy the given requirement.
