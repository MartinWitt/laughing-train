...
in `src/main/java/org/apache/commons/imaging/common/BinaryOutputStream.java`
#### Snippet
```java
...
### NonProtectedConstructorInAbstractClass
Constructor `BinaryOutputStream()` of an abstract class should not be declared 'public'
in `src/main/java/org/apache/commons/imaging/common/BinaryOutputStream.java`
#### Snippet
```java
    }
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-19-04-51-13.710.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
