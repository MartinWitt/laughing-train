...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-10-11-33-50.682.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### DataFlowIssue
Method invocation `listRevisions` may produce `NullPointerException`
