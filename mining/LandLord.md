...
# Bad smells
I found 188 bad smells with 11 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 35 | false |
| TrivialStringConcatenation | 29 | false |
| ThrowablePrintStackTrace | 15 | false |
...
### ConstantConditions
Condition `plugin instanceof WorldGuardPlugin` is redundant and can be replaced with a null check
