...
# Bad smells
I found 1873 bad smells with 52 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 689 | false |
| AssignmentToMethodParameter | 318 | false |
| BoundedWildcard | 308 | false |
| PatternVariableCanBeUsed | 101 | false |
| SystemOutErr | 69 | false |
| EnhancedSwitchMigration | 47 | false |
...
### ConstantValue
Condition `body.getTerm() == null` is always `false`
in `base/src/main/java/org/arend/term/concrete/ReplaceDataVisitor.java`
#### Snippet
```java
