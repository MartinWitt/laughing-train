...
# Bad smells
I found 1911 bad smells with 52 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 680 | false |
| AssignmentToMethodParameter | 313 | false |
| BoundedWildcard | 297 | false |
| PatternVariableCanBeUsed | 152 | false |
| SystemOutErr | 69 | false |
| EnhancedSwitchMigration | 57 | false |
...
## RuleId[ruleID=SuspiciousListRemoveInLoop]
...
### UNUSED_IMPORT
Unused import `import org.arend.ext.reference.Precedence;`
in `base/src/main/java/org/arend/naming/reference/TCReferable.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.arend.module.ModuleLocation;`
in `base/src/main/java/org/arend/naming/reference/TCReferable.java`
#### Snippet
```java
import org.arend.ext.reference.DataContainer;
...
Cast to 'FunctionDefinition' type conflicts with preceding 'instanceof TopLevelDefinition' check
in `base/src/main/java/org/arend/typechecking/order/listener/TypecheckingOrderingListener.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'arrayData' can be replaced with pattern variable
in `base/src/main/java/org/arend/core/pattern/ConstructorExpressionPattern.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'appExpr' can be replaced with pattern variable
in `cli/src/main/java/org/arend/frontend/parser/BuildVisitor.java`
#### Snippet
```java
      return false;
...
### PatternVariableCanBeUsed
Variable 'caseArgExpr' can be replaced with pattern variable
in `cli/src/main/java/org/arend/frontend/parser/BuildVisitor.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'caseArgElim' can be replaced with pattern variable
in `cli/src/main/java/org/arend/frontend/parser/BuildVisitor.java`
#### Snippet
```java
        caseArgs.add(new Concrete.CaseArgument(visitExpr(caseArgExpr.expr2()), id == null ? null : new ParsedLocalReferable(tokenPosition(id.getSymbol()), id.getText()), type));
...
### PatternVariableCanBeUsed
Variable 'fieldStatCtx' can be replaced with pattern variable
in `cli/src/main/java/org/arend/frontend/parser/BuildVisitor.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'overrideCtx' can be replaced with pattern variable
in `cli/src/main/java/org/arend/frontend/parser/BuildVisitor.java`
#### Snippet
```java
          elements.add(visitClassFieldDef(fieldStatCtx.classFieldDef(), (ClassFieldKind) visit(fieldStatCtx.fieldMod()), parentClass));
...
### PatternVariableCanBeUsed
Variable 'tcDefReferable' can be replaced with pattern variable
in `base/src/main/java/org/arend/module/serialization/ModuleDeserialization.java`
#### Snippet
```java
      }
...
### PatternVariableCanBeUsed
Variable 'enclosingFunction' can be replaced with pattern variable
in `base/src/main/java/org/arend/naming/resolving/visitor/DefinitionResolveNameVisitor.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'fun' can be replaced with pattern variable
...
### PatternVariableCanBeUsed
Variable 'piType' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/doubleChecker/CoreDefinitionChecker.java`
#### Snippet
```java
            return false;
...
### PatternVariableCanBeUsed
Variable 'typeClassCall' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/doubleChecker/CoreDefinitionChecker.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'dataClauseElem' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/patternmatching/Util.java`
#### Snippet
```java
...
### PatternVariableCanBeUsed
Variable 'classFieldImpl' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/visitor/DefinitionTypechecker.java`
#### Snippet
```java
        }
...
### PatternVariableCanBeUsed
Variable 'elimBody' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/visitor/DefinitionTypechecker.java`
#### Snippet
```java
      }
...
### PatternVariableCanBeUsed
Variable 'classDef' can be replaced with pattern variable
in `base/src/main/java/org/arend/typechecking/visitor/DefinitionTypechecker.java`
#### Snippet
```java
