...
# Bad smells
I found 278 bad smells with 0 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| NullableProblems | 176 | false |
...
### DuplicatedCode
Duplicated code
in `instancio-core/src/main/java/org/instancio/internal/reflection/DeclaredAndInheritedFieldsCollector.java`
#### Snippet
```java
        Class<?> next = klass;
