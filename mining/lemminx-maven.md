...
# Bad smells
I found 296 bad smells with 38 repairable:
...
| EnhancedSwitchMigration | 7 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-26-18-30-36.294.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
