...
# Bad smells
I found 289 bad smells with 29 repairable:
...
in `gson/src/main/java/com/google/gson/FormattingStyle.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-03-07-18-26-09.009.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
