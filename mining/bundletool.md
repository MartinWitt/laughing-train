...
# Bad smells
I found 859 bad smells with 23 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 152 | false |
| AbstractClassNeverImplemented | 141 | false |
...
### BoundedWildcard
Can generalize to `? extends DirectoryNestedTargeting`
in `src/main/java/com/android/tools/build/bundletool/validation/NestedTargetingValidator.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `DirectoryNestedTargeting` has no concrete subclass
in `src/main/java/com/android/tools/build/bundletool/validation/NestedTargetingValidator.java`
#### Snippet
```java
...
### AbstractClassNeverImplemented
Abstract class `DimensionKeyValue` has no concrete subclass
in `src/main/java/com/android/tools/build/bundletool/model/targeting/DimensionKeyValue.java`
#### Snippet
```java
 */
@AutoValue
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `src/main/java/com/android/tools/build/bundletool/device/GlExtensionsParser.java`
#### Snippet
```java
