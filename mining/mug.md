...
# Bad smells
I found 325 bad smells with 15 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 149 | false |
| ReturnNull | 52 | false |
...
| OptionalContainsCollection | 7 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-01-00-28-06.703.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
