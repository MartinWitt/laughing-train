...
# Bad smells
I found 317 bad smells with 16 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| BoundedWildcard | 148 | false |
| ReturnNull | 49 | false |
| OptionalUsedAsFieldOrParameterType | 20 | false |
...
in `mug/src/main/java/com/google/mu/util/StringTemplate.java`
#### Snippet
```java
...
in `mug/src/main/java/com/google/mu/util/stream/ShortListCollector.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-12-13-53-27.781.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
