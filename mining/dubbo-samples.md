...
### UtilityClassWithoutPrivateConstructor
Class `ProviderApplication` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-callback/dubbo-samples-callback-provider/src/main/java/org/apache/dubbo/samples/callback/provider/ProviderApplication.java`
#### Snippet
```java
@SpringBootApplication
@EnableDubbo
...
in `2-advanced/dubbo-samples-attachment/dubbo-samples-attachment-provider/src/main/java/org/apache/dubbo/samples/attachment/AttachmentProvider.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
### UtilityClassWithoutPrivateConstructor
Class `Application` has only 'static' members, and lacks a 'private' constructor
in `99-integration/dubbo-samples-test-11782/src/main/java/org/apache/dubbo/samples/provider/Application.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `Application` has only 'static' members, and lacks a 'private' constructor
in `99-integration/dubbo-samples-test-11716/src/main/java/org/apache/dubbo/samples/provider/Application.java`
#### Snippet
```java
import org.apache.dubbo.samples.api.GreetingsService;
...
### UtilityClassWithoutPrivateConstructor
Class `MergeProvider1` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-merge/dubbo-samples-merge-provider1/src/main/java/org/apache/dubbo/samples/merge/MergeProvider1.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
### UtilityClassWithoutPrivateConstructor
Class `ExtensibilityProtocolConsumerApplication` has only 'static' members, and lacks a 'private' constructor
in `10-task/dubbo-samples-extensibility/dubbo-samples-extensibility-protocol-consumer/src/main/java/org/apache/dubbo/sample/extensibility/protocol/consume/ExtensibilityProtocolConsumerApplication.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
in `2-advanced/dubbo-samples-echo/dubbo-samples-echo-provider/src/main/java/org/apache/dubbo/samples/provider/EchoProvider.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
in `2-advanced/dubbo-samples-echo/dubbo-samples-echo-consumer/src/main/java/org/apache/dubbo/samples/consumer/EchoConsumer.java`
#### Snippet
```java
@SpringBootApplication
@EnableDubbo
...
### UtilityClassWithoutPrivateConstructor
Class `ProviderApplication` has only 'static' members, and lacks a 'private' constructor
in `4-governance/dubbo-samples-spring-boot-tracing/dubbo-samples-spring-boot-tracing-provider/src/main/java/org/apache/dubbo/springboot/demo/provider/ProviderApplication.java`
#### Snippet
```java
@SpringBootApplication
@EnableDubbo
...
### UtilityClassWithoutPrivateConstructor
Class `MergeConsumer1` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-merge/dubbo-samples-merge-consumer1/src/main/java/org/apache/dubbo/samples/merge/MergeConsumer1.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
### UtilityClassWithoutPrivateConstructor
Class `ProviderApplication` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-async/dubbo-samples-async-simple-boot/dubbo-samples-async-simple-boot-provider/src/main/java/org/apache/dubbo/async/boot/provider/ProviderApplication.java`
#### Snippet
```java
@SpringBootApplication
@EnableDubbo
...
### UtilityClassWithoutPrivateConstructor
Class `ExtensibilityProtocolProviderApplication` has only 'static' members, and lacks a 'private' constructor
in `10-task/dubbo-samples-extensibility/dubbo-samples-extensibility-protocol-provider/src/main/java/org/apache/dubbo/samples/extensibility/protocol/provider/ExtensibilityProtocolProviderApplication.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
### UtilityClassWithoutPrivateConstructor
Class `SecurityConsumer` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/SecurityConsumer.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `SecurityProvider` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/SecurityProvider.java`
#### Snippet
```java
import java.util.concurrent.CountDownLatch;
...
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/zookeeper/ZKTools.java`
#### Snippet
```java
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `4-governance/dubbo-samples-metrics-spring-boot/src/main/java/org/apache/dubbo/samples/metrics/springboot/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-callback/dubbo-samples-callback-provider/src/main/java/org/apache/dubbo/samples/callback/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-attachment/dubbo-samples-attachment-provider/src/main/java/org/apache/dubbo/samples/attachment/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-merge/dubbo-samples-merge-provider1/src/main/java/org/apache/dubbo/samples/merge/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-echo/dubbo-samples-echo-provider/src/main/java/org/apache/dubbo/samples/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `4-governance/dubbo-samples-metrics-prometheus/dubbo-samples-metrics-prometheus-consumer/src/main/java/org/apache/dubbo/samples/metrics/prometheus/consumer/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `4-governance/dubbo-samples-spring-boot-tracing/dubbo-samples-spring-boot-tracing-provider/src/main/java/org/apache/dubbo/springboot/demo/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `4-governance/dubbo-samples-metrics-prometheus/dubbo-samples-metrics-prometheus-provider/src/main/java/org/apache/dubbo/samples/metrics/prometheus/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-async/dubbo-samples-async-simple-boot/dubbo-samples-async-simple-boot-provider/src/main/java/org/apache/dubbo/async/boot/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
### SimplifyStreamApiCallChains
Can be replaced with 'boxed'
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/zookeeper/EmbeddedZooKeeper.java`
#### Snippet
```java
        List<Integer> randomInts = RANDOM.ints(min, max + 1)
                .limit(max - min)
...
in `2-advanced/dubbo-samples-callback/dubbo-samples-callback-consumer/src/main/java/org/apache/dubbo/samples/callback/consumer/Task.java`
#### Snippet
```java
    @Override
...
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/client/UserServiceClient.java`
#### Snippet
```java
    }
...
### IgnoreResultOfCall
Result of `InputStream.read()` is ignored
in `2-advanced/dubbo-samples-echo/dubbo-samples-echo-consumer/src/main/java/org/apache/dubbo/samples/consumer/Task.java`
#### Snippet
```java
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-merge/dubbo-samples-merge-consumer2/src/main/java/org/apache/dubbo/samples/merge/Task.java`
#### Snippet
```java
    @Override
    public void run(String... args) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-async/dubbo-samples-async-simple-boot/dubbo-samples-async-simple-boot-consumer/src/main/java/org/apache/dubbo/async/boot/consumer/Task.java`
#### Snippet
```java
        helloFuture.whenComplete((retValue, exception) -> {
            if (exception == null) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-attachment/dubbo-samples-attachment-consumer/src/main/java/org/apache/dubbo/samples/attachment/AttachmentConsumer.java`
#### Snippet
```java
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-attachment/dubbo-samples-attachment-provider/src/main/java/org/apache/dubbo/samples/attachment/impl/AttachmentImpl.java`
#### Snippet
```java
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `10-task/dubbo-samples-extensibility/dubbo-samples-extensibility-protocol-consumer/src/main/java/org/apache/dubbo/sample/extensibility/protocol/consume/ExtensibilityProtocolConsumerTask.java`
#### Snippet
```java
    @Override
    public void run(String... args) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-echo/dubbo-samples-echo-provider/src/main/java/org/apache/dubbo/samples/provider/impl/DemoServiceImpl.java`
#### Snippet
```java
    @Override
    public String sayHello(String name) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-merge/dubbo-samples-merge-consumer1/src/main/java/org/apache/dubbo/samples/merge/Task.java`
#### Snippet
```java
    @Override
    public void run(String... args) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-spring-security/src/main/java/org/apache/dubbo/samples/custom/DefaultObjectMapperCodecCustomer.java`
#### Snippet
```java
    @Override
...
### ImplicitArrayToString
Call to 'toString()' on array
in `4-governance/dubbo-samples-metrics-prometheus/dubbo-samples-metrics-prometheus-provider/src/main/java/org/apache/dubbo/samples/metrics/prometheus/provider/impl/DemoServiceImpl2.java`
#### Snippet
```java
    @Override
    public String stringArray(String[] bytes) {
...
### ImplicitArrayToString
Call to 'toString()' on array
in `4-governance/dubbo-samples-metrics-prometheus/dubbo-samples-metrics-prometheus-provider/src/main/java/org/apache/dubbo/samples/metrics/prometheus/provider/impl/DemoServiceImpl.java`
#### Snippet
```java
    @Override
    public String stringArray(String[] bytes) {
...
### UNUSED_IMPORT
Unused import `import org.apache.dubbo.samples.callback.api.CallbackListener;`
in `2-advanced/dubbo-samples-callback/dubbo-samples-callback-consumer/src/main/java/org/apache/dubbo/samples/callback/consumer/Task.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.apache.dubbo.samples.metrics.prometheus.api.DemoService;`
in `4-governance/dubbo-samples-metrics-prometheus/dubbo-samples-metrics-prometheus-provider/src/main/java/org/apache/dubbo/samples/metrics/prometheus/provider/impl/DemoServiceImpl2.java`
#### Snippet
```java
...
### ThrowablePrintStackTrace
Call to `printStackTrace()` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-callback/dubbo-samples-callback-provider/src/main/java/org/apache/dubbo/samples/callback/provider/CallbackServiceImpl.java`
#### Snippet
```java
