...
# Bad smells
I found 1660 bad smells with 363 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| SystemOutErr | 693 | false |
| UtilityClassWithoutPrivateConstructor | 346 | true |
| IOResource | 206 | false |
| ThrowablePrintStackTrace | 91 | false |
...
| InfiniteLoopStatement | 14 | false |
| BusyWait | 14 | false |
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/MybatisConsumer.java`
#### Snippet
```java
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/HibernateProvider.java`
#### Snippet
```java
        new EmbeddedZooKeeper(2181, false).start();
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/HibernateConsumer.java`
#### Snippet
```java
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/NotifyProvider.java`
#### Snippet
```java
        new EmbeddedZooKeeper(2181, false).start();
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/NotifyConsumer.java`
#### Snippet
```java
...
### IOResource
'AnnotationConfigApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-autowire/src/main/java/org/apache/dubbo/samples/autowire/ProviderBootstrap.java`
#### Snippet
```java
        new EmbeddedZooKeeper(2181, false).start();
...
### IOResource
'AnnotationConfigApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-autowire/src/main/java/org/apache/dubbo/samples/autowire/ConsumerBootstrap.java`
#### Snippet
```java
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `1-basic/dubbo-samples-basic/src/main/java/org/apache/dubbo/samples/basic/BasicProvider.java`
#### Snippet
```java
        Thread.sleep(1000);
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `1-basic/dubbo-samples-basic/src/main/java/org/apache/dubbo/samples/basic/BasicConsumer.java`
#### Snippet
```java
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-stub/src/main/java/org/apache/dubbo/samples/stub/StubConsumer.java`
#### Snippet
```java
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-stub/src/main/java/org/apache/dubbo/samples/stub/StubProvider.java`
#### Snippet
```java
        new EmbeddedZooKeeper(2181, false).start();
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-cache/src/main/java/org/apache/dubbo/samples/cache/CacheProvider.java`
#### Snippet
```java
        new EmbeddedZooKeeper(2181, false).start();
...
### IOResource
'ClassPathXmlApplicationContext' should be opened in front of a 'try' block and closed in the corresponding 'finally' block
in `2-advanced/dubbo-samples-cache/src/main/java/org/apache/dubbo/samples/cache/CacheConsumer.java`
#### Snippet
```java
...
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/impl/dao/UserDao.java`
#### Snippet
```java
@Repository
...
### UtilityClassWithoutPrivateConstructor
Class `MybatisConsumer` has only 'static' members, and lacks a 'private' constructor
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/MybatisConsumer.java`
#### Snippet
```java
import org.springframework.context.support.ClassPathXmlApplicationContext;
...
in `10-task/dubbo-samples-shop/dubbo-samples-shop-detail/src/main/java/org/apache/dubbo/samples/detail/DetailApplication.java`
#### Snippet
```java
@EnableDubbo
@SpringBootApplication
...
### UtilityClassWithoutPrivateConstructor
Class `HibernateProvider` has only 'static' members, and lacks a 'private' constructor
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/HibernateProvider.java`
#### Snippet
```java
import java.util.concurrent.CountDownLatch;
...
### UtilityClassWithoutPrivateConstructor
Class `HibernateConsumer` has only 'static' members, and lacks a 'private' constructor
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/HibernateConsumer.java`
#### Snippet
```java
...
### UtilityClassWithoutPrivateConstructor
Class `NotifyProvider` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/NotifyProvider.java`
#### Snippet
```java
import java.util.concurrent.CountDownLatch;
...
### UtilityClassWithoutPrivateConstructor
Class `NotifyConsumer` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/NotifyConsumer.java`
#### Snippet
```java
import org.springframework.context.support.ClassPathXmlApplicationContext;
...
### UtilityClassWithoutPrivateConstructor
Class `StubConsumer` has only 'static' members, and lacks a 'private' constructor
in `2-advanced/dubbo-samples-stub/src/main/java/org/apache/dubbo/samples/stub/StubConsumer.java`
#### Snippet
```java
import org.springframework.context.support.ClassPathXmlApplicationContext;
...
in `10-task/dubbo-samples-shop/dubbo-samples-shop-order-v2/src/main/java/org/apache/dubbo/samples/order/OrderServiceImpl.java`
#### Snippet
```java
...
### IgnoreResultOfCall
Result of `Math.pow()` is ignored
in `10-task/dubbo-samples-shop/dubbo-samples-shop-detail/src/main/java/org/apache/dubbo/samples/detail/DetailServiceImpl.java`
#### Snippet
```java
            // Do something that consumes resources
            for (int i = 0; i < 1000; i++) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `4-governance/dubbo-samples-tracing/dubbo-samples-tracing-provider/src/main/java/org/apache/dubbo/springboot/demo/provider/ObservationConfiguration.java`
#### Snippet
```java
        @PreDestroy
        void dumpMetrics() {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/MybatisProvider.java`
#### Snippet
```java
    @Override
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/impl/NotifyImpl.java`
#### Snippet
```java
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `2-advanced/dubbo-samples-autowire/src/main/java/org/apache/dubbo/samples/autowire/impl/HelloServiceImpl.java`
#### Snippet
```java
    @Override
    public String sayHello(String name) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `1-basic/dubbo-samples-spring-boot/dubbo-samples-spring-boot-provider/src/main/java/org/apache/dubbo/springboot/demo/provider/DemoServiceImpl.java`
#### Snippet
```java
    @Override
    public String sayHello(String name) {
...
### SystemOutErr
Uses of `System.out` should probably be replaced with more robust logging
in `1-basic/dubbo-samples-basic/src/main/java/org/apache/dubbo/samples/basic/impl/DemoServiceImpl.java`
#### Snippet
```java
    @Override
    public String sayHello(String name) {
...
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/api/User.java`
#### Snippet
```java
...
### UnnecessaryFullyQualifiedName
Qualifier `java.io` is unnecessary, and can be replaced with an import
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/api/User.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import org.springframework.boot.CommandLineRunner;`
in `2-advanced/dubbo-samples-seata/dubbo-samples-seata-account/src/main/java/org/apache/dubbo/samples/seata/AccountServiceImpl.java`
#### Snippet
```java
...
in `2-advanced/dubbo-samples-seata/dubbo-samples-seata-business/src/main/java/org/apache/dubbo/samples/seata/BusinessServiceImpl.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import io.seata.rm.datasource.DataSourceProxy;`
in `2-advanced/dubbo-samples-seata/dubbo-samples-seata-order/src/main/java/org/apache/dubbo/samples/seata/OrderApplication.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import io.seata.spring.annotation.GlobalTransactionScanner;`
in `2-advanced/dubbo-samples-seata/dubbo-samples-seata-order/src/main/java/org/apache/dubbo/samples/seata/OrderApplication.java`
#### Snippet
```java
...
in `1-basic/dubbo-samples-basic/src/main/java/org/apache/dubbo/samples/basic/api/DemoService.java`
#### Snippet
```java
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `99-integration/dubbo-samples-mybatis/src/main/java/org/apache/dubbo/samples/boundary/mybatis/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `99-integration/dubbo-samples-hibernate/src/main/java/org/apache/dubbo/samples/boundary/hibernate/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `2-advanced/dubbo-samples-notify/src/main/java/org/apache/dubbo/samples/notify/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `2-advanced/dubbo-samples-autowire/src/main/java/org/apache/dubbo/samples/autowire/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `1-basic/dubbo-samples-basic/src/main/java/org/apache/dubbo/samples/basic/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `1-basic/dubbo-samples-spring-boot/dubbo-samples-spring-boot-provider/src/main/java/org/apache/dubbo/springboot/demo/provider/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `2-advanced/dubbo-samples-cache/src/main/java/org/apache/dubbo/samples/cache/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
### RedundantFieldInitialization
Field initialization to `0` is redundant
in `2-advanced/dubbo-samples-stub/src/main/java/org/apache/dubbo/samples/stub/EmbeddedZooKeeper.java`
#### Snippet
```java
     * Lifecycle phase. Default is 0.
     */
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-31-14-15-11.328.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### ReturnNull
Return of `null`
in `2-advanced/dubbo-samples-stub/src/main/java/org/apache/dubbo/samples/stub/api/DemoServiceStub.java`
#### Snippet
```java
        } catch (Exception e) {
