...
# Bad smells
I found 1817 bad smells with 413 repairable:
...
| PatternVariableCanBeUsed | 162 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-12-11-16-15-17.952.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
