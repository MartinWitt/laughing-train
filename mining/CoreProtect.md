...
# Bad smells
I found 1815 bad smells with 410 repairable:
...
| AssignmentToStaticFieldFromInstanceMethod | 63 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-12-17-05-07-14.880.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
