...
# Bad smells
I found 1819 bad smells with 411 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| SizeReplaceableByIsEmpty | 237 | true |
| ThrowablePrintStackTrace | 207 | false |
| DynamicRegexReplaceableByCompiledPattern | 173 | false |
| PatternVariableCanBeUsed | 163 | false |
| AssignmentToMethodParameter | 103 | false |
| DataFlowIssue | 87 | false |
| ConstantValue | 74 | false |
...
| EnhancedSwitchMigration | 35 | false |
| ReturnNull | 33 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-03-11-17-30-49.194.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
