...
# Bad smells
I found 1348 bad smells with 137 repairable:
...
| AssignmentToMethodParameter | 76 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-03-11-07-01-36.114.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
