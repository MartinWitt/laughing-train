...
# Bad smells
I found 1346 bad smells with 105 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| RuleId[ruleID=ReturnNull] | 224 | false |
| RuleId[ruleID=BoundedWildcard] | 170 | false |
| RuleId[ruleID=UnnecessaryFullyQualifiedName] | 99 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-11-21-03-57-23.806.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
