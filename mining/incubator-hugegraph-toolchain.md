...
# Bad smells
I found 560 bad smells with 123 repairable:
...
### HtmlWrongAttributeValue
Wrong attribute value
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-23-13-35-29.694.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### ConstantValue
Value `info.trustStoreFile` is always 'null'
in `hugegraph-tools/src/main/java/org/apache/hugegraph/base/ToolClient.java`
#### Snippet
```java
...
### ConstantValue
Value `info.trustStorePassword` is always 'null'
in `hugegraph-tools/src/main/java/org/apache/hugegraph/base/ToolClient.java`
#### Snippet
```java
                            "Can't set --trust-store-password when use http");
