...
# Bad smells
I found 1139 bad smells with 131 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 285 | false |
| GroovyUnusedAssignment | 154 | false |
| BoundedWildcard | 131 | false |
| ProtectedMemberInFinalClass | 68 | true |
| DynamicRegexReplaceableByCompiledPattern | 54 | false |
...
### ConstantValue
Condition `resource instanceof Template` is always `false`
...
### ConstantValue
Condition `item instanceof Route` is always `true`
in `jkube-kit/enricher/generic/src/main/java/org/eclipse/jkube/enricher/generic/openshift/RouteEnricher.java`
#### Snippet
```java
...
### ConstantValue
Condition `entity instanceof ReplicationController` is always `false`
in `jkube-kit/common/src/main/java/org/eclipse/jkube/kit/common/util/KubernetesHelper.java`
#### Snippet
```java
...
### ConstantValue
Condition `entity instanceof DaemonSet` is always `false`
in `jkube-kit/common/src/main/java/org/eclipse/jkube/kit/common/util/KubernetesHelper.java`
#### Snippet
```java
                selector = toLabelSelector(spec.getSelector());
...
### ConstantValue
Condition `entity instanceof StatefulSet` is always `false`
in `jkube-kit/common/src/main/java/org/eclipse/jkube/kit/common/util/KubernetesHelper.java`
#### Snippet
```java
...
### ConstantValue
Condition `entity instanceof Job` is always `false`
in `jkube-kit/common/src/main/java/org/eclipse/jkube/kit/common/util/KubernetesHelper.java`
#### Snippet
```java
                selector = spec.getSelector();
...
### ConstantValue
Condition `entity instanceof DeploymentConfig` is always `false`
...
### DataFlowIssue
Condition `singleEntity instanceof Template` is redundant and can be replaced with a null check
...
### DataFlowIssue
Condition `template instanceof Template` is redundant and can be replaced with a null check
in `jkube-kit/resource/service/src/main/java/org/eclipse/jkube/kit/resource/service/TemplateUtil.java`
#### Snippet
```java
...
### DataFlowIssue
Condition `entity instanceof DeploymentConfig` is redundant and can be replaced with a null check
in `jkube-kit/watcher/standard/src/main/java/org/eclipse/jkube/watcher/standard/DockerImageWatcher.java`
#### Snippet
```java
...
### DataFlowIssue
Condition `item instanceof DeploymentConfig` is redundant and can be replaced with a null check
...
### DataFlowIssue
Condition `dto instanceof Template` is redundant and can be replaced with a null check
in `jkube-kit/resource/helm/src/main/java/org/eclipse/jkube/kit/resource/helm/HelmServiceUtil.java`
#### Snippet
```java
...
### DataFlowIssue
Condition `resource instanceof Template` is redundant and can be replaced with a null check
in `jkube-kit/enricher/generic/src/main/java/org/eclipse/jkube/enricher/generic/DependencyEnricher.java`
#### Snippet
```java
...
### DataFlowIssue
Condition `entity instanceof ImageStream` is redundant and can be replaced with a null check
in `jkube-kit/config/service/src/main/java/org/eclipse/jkube/kit/config/service/openshift/OpenshiftUndeployService.java`
#### Snippet
```java
...
### DataFlowIssue
Condition `h instanceof Project` is redundant and can be replaced with a null check
in `jkube-kit/config/service/src/main/java/org/eclipse/jkube/kit/config/service/ApplyService.java`
#### Snippet
```java
