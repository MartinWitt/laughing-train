...
# Bad smells
I found 1097 bad smells with 129 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 284 | false |
| GroovyUnusedAssignment | 148 | false |
| BoundedWildcard | 136 | false |
...
| UnnecessaryStringEscape | 3 | false |
...
### UNUSED_IMPORT
Unused import `import io.fabric8.kubernetes.api.model.ResourceRequirements;`
in `jkube-kit/enricher/generic/src/main/java/org/eclipse/jkube/enricher/generic/VolumePermissionEnricher.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-04-09-01-46.086.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### InnerClassMayBeStatic
Inner class `ConstraintViolationImpl` may be 'static'
in `jkube-kit/common/src/main/java/org/eclipse/jkube/kit/common/util/validator/ResourceValidator.java`
#### Snippet
```java
    }
