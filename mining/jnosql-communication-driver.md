...
# Bad smells
I found 585 bad smells with 4 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| UNCHECKED_WARNING | 166 | false |
| JavadocReference | 125 | false |
| RedundantClassCall | 106 | false |
| CdiInjectionPointsInspection | 34 | false |
...
### DuplicatedCode
Duplicated code
in `jnosql-couchbase/src/main/java/org/eclipse/jnosql/databases/couchbase/communication/DefaultCouchbaseDocumentManager.java`
#### Snippet
```java
