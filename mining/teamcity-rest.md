...
in `src/jetbrains/buildServer/server/rest/data/FinderImpl.java`
#### Snippet
```java
...
### WrapperTypeMayBePrimitive
Type may be primitive
in `src/jetbrains/buildServer/server/rest/data/mutes/MuteFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/ProjectFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/VcsRootFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/BuildPromotionFinder.java`
#### Snippet
```java
...
### CommentedOutCode
Commented out code (4 lines)
in `src/jetbrains/buildServer/server/rest/data/TypedFinderBuilder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/BuildArtifactsFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/BuildFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/ChangeFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/GraphFinder.java`
#### Snippet
```java
  }
...
### BoundedWildcard
Can generalize to `? super T`
in `src/jetbrains/buildServer/server/rest/data/PagingItemFilter.java`
#### Snippet
```java
...
### BoundedWildcard
Can generalize to `? extends DATA`
in `src/jetbrains/buildServer/server/rest/data/problem/tree/ScopeTree.java`
#### Snippet
```java
...
### BoundedWildcard
Can generalize to `? super T`
in `src/jetbrains/buildServer/server/rest/data/FilterItemProcessor.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/BranchFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/AgentFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/UserFinder.java`
#### Snippet
```java
  }
...
### MissortedModifiers
Missorted modifiers `final @Nullable`
in `src/jetbrains/buildServer/server/rest/data/VcsRootInstanceFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/util/CollectionItemHolder.java`
#### Snippet
```java
...
### MissortedModifiers
Missorted modifiers `final private`
in `src/jetbrains/buildServer/server/rest/data/util/FlatteningItemHolder.java`
#### Snippet
```java
 */
...
### MissortedModifiers
Missorted modifiers `final @NotNull`
in `src/jetbrains/buildServer/server/rest/data/BuildTypeFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/HealthItemFinder.java`
#### Snippet
```java
  @NotNull
  @Override
...
### UNUSED_IMPORT
Unused import `import java.util.stream.Collectors;`
in `src/jetbrains/buildServer/server/rest/data/PermissionAssignmentFinder.java`
#### Snippet
```java
...
in `src/jetbrains/buildServer/server/rest/data/problem/scope/TestScopeFilterProducer.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import io.swagger.annotations.ExtensionProperty;`
in `src/jetbrains/buildServer/server/rest/model/Links.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import io.swagger.annotations.Api;`
in `src/jetbrains/buildServer/server/rest/model/buildType/Investigation.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.data.problem.scope.TestScopeType;`
in `src/jetbrains/buildServer/server/rest/model/problem/scope/AbstractNode.java`
#### Snippet
```java
import javax.xml.bind.annotation.XmlRootElement;
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.data.problem.tree.Scope;`
in `src/jetbrains/buildServer/server/rest/model/problem/scope/AbstractNode.java`
#### Snippet
```java
import javax.xml.bind.annotation.XmlType;
...
in `src/jetbrains/buildServer/server/rest/model/user/Permission.java`
#### Snippet
```java
import jetbrains.buildServer.server.rest.util.ValueWithDefault;
import org.jetbrains.annotations.NotNull;
...
### UNUSED_IMPORT
Unused import `import io.swagger.annotations.ExtensionProperty;`
in `src/jetbrains/buildServer/server/rest/model/user/Users.java`
#### Snippet
```java
import javax.xml.bind.annotation.XmlType;
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.ApiUrlBuilder;`
in `src/jetbrains/buildServer/server/rest/request/ChangeRequest.java`
#### Snippet
```java
import java.util.stream.Stream;
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.util.BeanFactory;`
in `src/jetbrains/buildServer/server/rest/request/ChangeRequest.java`
#### Snippet
```java
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.request.Constants;`
...
### UNUSED_IMPORT
Unused import `import jetbrains.buildServer.server.rest.data.Locator;`
...
in `src/jetbrains/buildServer/server/rest/data/FilterUtil.java`
#### Snippet
```java
...
### CodeBlock2Expr
Statement lambda can be replaced with expression lambda
in `src/jetbrains/buildServer/server/rest/data/CloudInstanceFinder.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/rest-api.f6f2b48a/diagnostic-2023-01-11-11-39-45.329.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### ZeroLengthArrayInitialization
Allocation of zero length array
in `src/jetbrains/buildServer/server/rest/data/AbstractFinder.java`
#### Snippet
```java
...
### UnusedAssignment
Variable `myMaxChildren` initializer `5` is redundant
in `src/jetbrains/buildServer/server/rest/data/problem/tree/TreeSlicingOptions.java`
#### Snippet
```java
...
### UnusedAssignment
Variable `myNodeComparator` initializer `null` is redundant
in `src/jetbrains/buildServer/server/rest/data/problem/tree/TreeSlicingOptions.java`
#### Snippet
```java
  private final Comparator<DATA> myDataComparator;
...
### UnusedAssignment
Variable `myMaxTotalNodes` initializer `null` is redundant
in `src/jetbrains/buildServer/server/rest/data/problem/tree/TreeSlicingOptions.java`
#### Snippet
```java
  private Comparator<ScopeTree.Node<DATA, COUNTERS>> myNodeComparator = null;
...
in `src/jetbrains/buildServer/server/rest/data/AuditEventFinder.java`
#### Snippet
```java
...
### DataFlowIssue
@Nullable method 'get' always returns a non-null value
in `src/jetbrains/buildServer/server/rest/model/NamedData.java`
#### Snippet
```java
...
### DataFlowIssue
@Nullable method 'get' always returns a non-null value
in `src/jetbrains/buildServer/server/rest/model/NamedDatas.java`
#### Snippet
```java
...
### Convert2MethodRef
Lambda can be replaced with method reference
in `src/jetbrains/buildServer/server/rest/data/CloudImageFinder.java`
#### Snippet
```java
...
### Convert2MethodRef
Lambda can be replaced with method reference
in `src/jetbrains/buildServer/server/rest/data/AgentPoolFinder.java`
#### Snippet
```java
...
### UnnecessaryToStringCall
Unnecessary `toString()` call
in `src/jetbrains/buildServer/server/rest/util/BeanFactory.java`
#### Snippet
```java
        result.append("null");
      } else {
...
### InnerClassMayBeStatic
Inner class `RestPluginWadlResource` may be 'static'
in `src/jetbrains/buildServer/server/rest/jersey/WadlGenerator.java`
#### Snippet
```java
    }
...
### RedundantSuppression
Redundant suppression
in `src/jetbrains/buildServer/server/rest/data/QueuedBuildFinder.java`
#### Snippet
```java
    if (locator.isSingleValue()) {
...
### ReturnNull
Return of `null`
in `src/jetbrains/buildServer/server/rest/jersey/SimplePathTransformer.java`
#### Snippet
```java
