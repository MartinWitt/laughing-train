...
# Bad smells
I found 1712 bad smells with 41 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| OptionalUsedAsFieldOrParameterType | 372 | false |
| AutoCloseableResource | 154 | false |
| FieldMayBeFinal | 133 | false |
| JavadocDeclaration | 104 | false |
| DuplicatedCode | 99 | false |
| Deprecation | 58 | false |
| FieldCanBeLocal | 48 | false |
| UNCHECKED_WARNING | 41 | false |
| OptionalGetWithoutIsPresent | 39 | false |
| DataFlowIssue | 39 | false |
| IgnoreResultOfCall | 31 | false |
...
| TrivialIf | 21 | false |
| SynchronizationOnLocalVariableOrMethodParameter | 21 | false |
| DeprecatedIsStillUsed | 21 | false |
| ThrowableNotThrown | 20 | false |
...
| PlaceholderCountMatchesArgumentCount | 8 | false |
...
### UnusedAssignment
Variable `nextBatch` initializer `null` is redundant
in `core/src/main/java/kafka/log/remote/RemoteLogManager.java`
#### Snippet
```java
...
### JavadocReference
Cannot resolve symbol `Transformation`
in `connect/runtime/src/main/java/org/apache/kafka/connect/runtime/TransformationChain.java`
#### Snippet
```java
...
### OptionalUsedAsFieldOrParameterType
`Optional` used as type for parameter 'leaderEpoch'
in `clients/src/main/java/org/apache/kafka/clients/consumer/internals/OffsetFetcher.java`
#### Snippet
```java
...
### AutoCloseableResource
'Serde' used without 'try'-with-resources statement
in `streams/src/main/java/org/apache/kafka/streams/state/internals/InMemoryTimeOrderedKeyValueBuffer.java`
#### Snippet
```java
