...
# Bad smells
I found 1289 bad smells with 155 repairable:
...
| UseOfPropertiesAsHashtable | 8 | false |
...
in `proxy/backend/src/main/java/org/apache/shardingsphere/proxy/backend/handler/DatabaseRequiredBackendHandler.java`
#### Snippet
```java
