...
# Bad smells
I found 1445 bad smells with 97 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| MissortedModifiers | 354 | false |
| ClassNameSameAsAncestorName | 156 | false |
| RedundantFieldInitialization | 152 | false |
| ReturnNull | 115 | false |
| PublicFieldAccessedInSynchronizedContext | 87 | false |
| BoundedWildcard | 71 | false |
| UnnecessarySuperQualifier | 54 | false |
...
### ClassNameSameAsAncestorName
Class name `VehicleGetTeleportingList` is the same as one of its superclass' names
...
### RedundantFieldInitialization
Field initialization to `null` is redundant
in `fed/mosaic-application/src/main/java/org/eclipse/mosaic/fed/application/ambassador/simulation/perception/index/providers/WallIndex.java`
#### Snippet
```java
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-30-13-02-14.878.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
