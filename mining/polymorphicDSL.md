...
# Bad smells
I found 1845 bad smells with 22 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| UnnecessaryFullyQualifiedName | 1348 | false |
| OptionalUsedAsFieldOrParameterType | 100 | false |
| OptionalContainsCollection | 75 | false |
...
### UNUSED_IMPORT
Unused import `import org.junit.jupiter.api.extension.ExtensionContext;`
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslGherkinInvocationContextProvider.java`
#### Snippet
```java
import com.pdsl.testcases.TestCaseFactory;
...
### UNUSED_IMPORT
Unused import `import org.junit.jupiter.api.extension.InvocationInterceptor;`
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslGherkinInvocationContextProvider.java`
#### Snippet
```java
import com.pdsl.transformers.PolymorphicDslPhraseFilter;
...
### UNUSED_IMPORT
Unused import `import org.junit.jupiter.api.extension.TestTemplateInvocationContext;`
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslGherkinInvocationContextProvider.java`
#### Snippet
```java
import org.junit.jupiter.api.extension.ExtensionContext;
...
### UNUSED_IMPORT
Unused import `import org.junit.jupiter.api.extension.TestTemplateInvocationContextProvider;`
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslGherkinInvocationContextProvider.java`
#### Snippet
```java
import org.junit.jupiter.api.extension.InvocationInterceptor;
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-05-01-10-34-41.097.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
### ExceptionNameDoesntEndWithException
Exception class name `TestFailure` does not end with 'Exception'
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslExecutable.java`
#### Snippet
```java
        }
...
### UnnecessaryFullyQualifiedName
Qualifier `org.junit.jupiter.engine.descriptor` is unnecessary and can be removed
in `src/main/java/org/junit/jupiter/engine/descriptor/PdslTestParameter.java`
#### Snippet
```java
/**
...
Assignment to method parameter `resourceRoot`
in `src/main/java/com/pdsl/runners/ExecutorHelper.java`
#### Snippet
```java
        {
