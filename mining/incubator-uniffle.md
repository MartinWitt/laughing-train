...
# Bad smells
I found 380 bad smells with 61 repairable:
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-04-26-20-37-57.617.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
...
Method `decode()` tries to override a static method of a superclass
...
in `common/src/main/java/org/apache/uniffle/common/netty/protocol/RequestMessage.java`
#### Snippet
```java
