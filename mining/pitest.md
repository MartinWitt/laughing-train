# hcoles/pitest
# Bad smells
I found 491 bad smells with 21 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| RuleId[ruleID=BoundedWildcard] | 130 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-11-14-07-20-24.745.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
