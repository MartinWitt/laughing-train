# hcoles/pitest
# Bad smells
I found 493 bad smells with 21 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| RuleId[ruleID=BoundedWildcard] | 131 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2022-11-15-07-50-19.567.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
