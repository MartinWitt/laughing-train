...
# Bad smells
I found 481 bad smells with 40 repairable:
...
| UnnecessaryQualifierForThis | 15 | false |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-02-26-04-56-40.209.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
