...
# Bad smells
I found 483 bad smells with 88 repairable:
| ruleID | number | fixable |
| --- | --- | --- |
| ReturnNull | 81 | false |
| SizeReplaceableByIsEmpty | 58 | true |
...
in `log/indexing-diagnostic/project.15375f63/diagnostic-2023-01-12-13-39-36.431.html`
#### Snippet
```java
              <td>0</td>
              <td>0</td>
