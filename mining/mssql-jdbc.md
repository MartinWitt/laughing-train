...
### UNUSED_IMPORT
Unused import `import java.security.cert.CertificateNotYetValidException;`
...
### FieldMayBeFinal
Field `activityIdTlsMap` may be 'final'
in `src/main/java/com/microsoft/sqlserver/jdbc/ActivityCorrelator.java`
#### Snippet
```java
