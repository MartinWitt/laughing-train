...
/**
 * This matcher checks if a given {@link CtInvocation} has an implicit toString call. This is the
 * case if the invocation is a call to one of the following methods:
 *
 * <ul>
 *   <li>{@link String#valueOf(Object)}
 *   <li>{@link StringBuilder#append(Object)}
 *   <li>{@link StringBuffer#append(Object)}
 *   <li>{@link PrintStream#print(Object)}
 *   <li>{@link PrintStream#println(Object)}
 *   <li>{@link PrintWriter#print(Object)}
 *   <li>{@link PrintWriter#println(Object)}
 *   <li>{@link Formatter#format(String, Object...)}
 * </ul>
 *
 * In this example for {code obj} of type {@link Object}:<br>
 * {@code System.out.println("Object: " + obj);} <br>
...
public class ImplicitToStringMatcher implements Filter<CtInvocation<?>> {
   ...
   * @return true if the specified {@link CtInvocation} object is a call to one of the methods
   *     above, false otherwise
   */
  private boolean appendMethod(CtInvocation<?> element, String qualifiedName) {
    return (qualifiedName.equals("java.lang.StringBuilder")
            || qualifiedName.equals("java.lang.StringBuffer"))
        && element.getArguments().size() == 1;
  }

  /**
   * Checks if the specified {@link CtInvocation} object is a call to the method {@link
   * String#valueOf(Object)}.
   *
   * @param element the {@link CtInvocation} object to check
   * @param qualifiedName the qualified name of the declaring type of the method
   * @return true if the specified {@link CtInvocation} object is a call to the method above, false
   *     otherwise
   */
  private boolean valueOfMethod(CtInvocation<?> element, String qualifiedName) {
    return qualifiedName.equals("java.lang.String") && element.getArguments().size() == 1;
  }
